...
(function() {
  ...
  function buildDiceStep() {
    ...
    var html = '<div class="step-heading">Step 4 — Assign Trait Dice</div>' +
      '<p style="color:var(--uj-text-muted);font-size:0.9rem;margin:0 0 1rem;">Assign the pool ' +
      '<strong style="color:var(--uj-amber);">d8, d8, d6, d4</strong> across your four traits. ' +
      'Two d8s for best traits, one d4 for worst.</p>' +
      '<div class="dice-grid">';
  ...
  function buildSummaryStep() {
    ...
    // Merge & deduplicate skills by id
    var skillMap = {};
    ...
    // Starting gear — deduplicate by normalised text
    var gearSeen = {};
    var gearLines = [];
