 ...
 * }
 */
function CG_Dev\\export_wp( $args = array() ) {
	global $wpdb, $post;
	 ...
	 */
	function CG_Dev\\wxr_cat_name( $category ) {
	 ...
	 * @param WP_Term $category Category Object.
	 */
	function CG_Dev\\wxr_category_description( $category ) {
	 ...
	 */
	function CG_Dev\\wxr_tag_name( $tag ) {
		if ( empty( $tag->name ) ) {
			return;
		}
	 ...
	 * @param WP_Term $tag Tag Object.
	 */
	function CG_Dev\\wxr_tag_description( $tag ) {
	 ...
	 */
	function CG_Dev\\wxr_term_name( $term ) {
		if ( empty( $term->name ) ) {
			return;
		}
	 ...
	 * @param WP_Term $term Term Object.
	 */
	function CG_Dev\\wxr_term_description( $term ) {
	 ...
	 * @param WP_Term $term Term object.
	 */
	function CG_Dev\\wxr_term_meta( $term ) {
		global $wpdb;
	 ...
	 */
	function CG_Dev\\wxr_authors_list( ?array $post_ids = null ) {
		global $wpdb;
	 ...
	 * @since 3.1.0
	 */
	function CG_Dev\\wxr_nav_menu_terms() {
	 ...
	 * @since 2.3.0
	 */
	function CG_Dev\\wxr_post_taxonomy() {
		$post = get_post();
	 ...
	 * @return bool
	 */
	function CG_Dev\\wxr_filter_postmeta( $return_me, $meta_key ) {
