 ...
 */
function CG_Dev\\wp_paused_plugins() {
	static $storage = null;
 ...
 * @return WP_Paused_Extensions_Storage
 */
function CG_Dev\\wp_paused_themes() {
	static $storage = null;
 ...
 */
function CG_Dev\\wp_get_extension_error_description( $error ) {
 ...
 * @since 5.2.0
 */
function CG_Dev\\wp_register_fatal_error_handler() {
 ...
 */
function CG_Dev\\wp_is_fatal_error_handler_enabled() {
 ...
 */
function CG_Dev\\wp_recovery_mode() {
