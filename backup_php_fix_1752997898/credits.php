 ...
 */
function CG_Dev\\wp_credits( $version = '', $locale = '' ) {
	if ( ! $version ) {
 ...
 */
function CG_Dev\\_wp_credits_add_profile_link( &$display_name, $username, $profiles ) {
 ...
 */
function CG_Dev\\_wp_credits_build_object_link( &$data ) {
 ...
 */
function CG_Dev\\wp_credits_section_title( $group_data = array() ) {
	if ( ! count( $group_data ) ) {
		return;
	}
 ...
 */
function CG_Dev\\wp_credits_section_list( $credits = array(), $slug = '' ) {
