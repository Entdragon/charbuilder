 ...
 */
function CG_Dev\\wp_should_replace_insecure_home_url() {
 ...
 */
function CG_Dev\\wp_replace_insecure_home_url( $content ) {
 ...
 */
function CG_Dev\\wp_update_urls_to_https() {
 ...
 */
function CG_Dev\\wp_update_https_migration_required( $old_url, $new_url ) {
