 ...
 */
function CG_Dev\\wp_list_widgets() {
 ...
 * @return int
 */
function CG_Dev\\_sort_name_callback( $a, $b ) {
 ...
 */
function CG_Dev\\wp_list_widget_controls( $sidebar, $sidebar_name = '' ) {
 ...
 * @return array
 */
function CG_Dev\\wp_list_widget_controls_dynamic_sidebar( $params ) {
 ...
 * @return array
 */
function CG_Dev\\wp_widget_control( $sidebar_args ) {
 ...
 * @return string
 */
function CG_Dev\\wp_widgets_access_body_class( $classes ) {
