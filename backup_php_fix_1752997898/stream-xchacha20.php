...
if (!is_callable('sodium_crypto_stream_xchacha20')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_stream_xchacha20(
        $len,
        $nonce,
        #[\SensitiveParameter]
        $key
...
if (!is_callable('sodium_crypto_stream_xchacha20_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_stream_xchacha20_keygen()
    {
...
if (!is_callable('sodium_crypto_stream_xchacha20_xor')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_stream_xchacha20_xor(
        #[\SensitiveParameter]
        $message,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_stream_xchacha20_xor_ic')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_stream_xchacha20_xor_ic(
        #[\SensitiveParameter]
        $message,
        $nonce,
        $counter,
