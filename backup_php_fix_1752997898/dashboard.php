 ...
 */
function CG_Dev\\wp_dashboard_setup() {
 ...
 */
function CG_Dev\\wp_add_dashboard_widget( $widget_id, $widget_name, $callback, $control_callback = null, $callback_args = null, $context = 'normal', $priority = 'core' ) {
 ...
 */
function CG_Dev\\_wp_dashboard_control_callback( $dashboard, $meta_box ) {
 ...
 * @since 2.7.0
 */
function CG_Dev\\wp_dashboard_right_now() {
	?>
	<div class="main">
	<ul>
	<?php
 ...
 * @since 3.1.0
 */
function CG_Dev\\wp_network_dashboard_right_now() {
	$actions = array();
 ...
 */
function CG_Dev\\wp_dashboard_quick_press( $error_msg = false ) {
	global $post_ID;
 ...
 */
function CG_Dev\\wp_dashboard_recent_drafts( $drafts = false ) {
	if ( ! $drafts ) {
		$query_args = array(
			'post_type'      => 'post',
			'post_status'    => 'draft',
 ...
 */
function CG_Dev\\_wp_dashboard_recent_comments_row( &$comment, $show_date = true ) {
 ...
 * @since 3.8.0
 */
function CG_Dev\\wp_dashboard_site_activity() {
 ...
 */
function CG_Dev\\wp_dashboard_recent_posts( $args ) {
	$query_args = array(
		'post_type'      => 'post',
 ...
 */
function CG_Dev\\wp_dashboard_recent_comments( $total_items = 5 ) {
 ...
 */
function CG_Dev\\wp_dashboard_rss_output( $widget_id ) {
 ...
 */
function CG_Dev\\wp_dashboard_cached_rss_widget( $widget_id, $callback, $check_urls = array(), ...$args ) {
 ...
 */
function CG_Dev\\wp_dashboard_trigger_widget_control( $widget_control_id = false ) {
	global $wp_dashboard_control_callbacks;
 ...
 */
function CG_Dev\\wp_dashboard_rss_control( $widget_id, $form_inputs = array() ) {
 ...
 * @since 4.8.0
 */
function CG_Dev\\wp_dashboard_events_news() {
 ...
 * @since 4.8.0
 */
function CG_Dev\\wp_print_community_events_markup() {
 ...
 * @since 4.8.0
 */
function CG_Dev\\wp_print_community_events_templates() {
	?>
 ...
 */
function CG_Dev\\wp_dashboard_primary() {
	$feeds = array(
		'news'   => array(
 ...
 */
function CG_Dev\\wp_dashboard_primary_output( $widget_id, $feeds ) {
 ...
 */
function CG_Dev\\wp_dashboard_quota() {
 ...
 * @global bool $is_IE
 */
function CG_Dev\\wp_dashboard_browser_nag() {
	global $is_IE;
 ...
 */
function CG_Dev\\dashboard_browser_nag_class( $classes ) {
	$response = wp_check_browser_version();
 ...
 */
function CG_Dev\\wp_check_browser_version() {
 ...
 * @since 5.1.0
 */
function CG_Dev\\wp_dashboard_php_nag() {
 ...
 * @return string[] Modified array of meta box classes.
 */
function CG_Dev\\dashboard_php_nag_class( $classes ) {
	$response = wp_check_php_version();
 ...
 * @since 5.4.0
 */
function CG_Dev\\wp_dashboard_site_health() {
 ...
 * @since 2.5.0
 */
function CG_Dev\\wp_dashboard_empty() {}
 ...
 */
function CG_Dev\\wp_welcome_panel() {
