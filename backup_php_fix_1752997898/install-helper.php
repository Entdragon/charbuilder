...
if ( ! function_exists( 'maybe_create_table' ) ) :
	 ...
	 */
	function CG_Dev\\maybe_create_table( $table_name, $create_ddl ) {
		global $wpdb;
...
if ( ! function_exists( 'maybe_add_column' ) ) :
	 ...
	 */
	function CG_Dev\\maybe_add_column( $table_name, $column_name, $create_ddl ) {
		global $wpdb;
 ...
 */
function CG_Dev\\maybe_drop_column( $table_name, $column_name, $drop_ddl ) {
	global $wpdb;
 ...
 */
function CG_Dev\\check_column( $table_name, $col_name, $col_type, $is_null = null, $key = null, $default_value = null, $extra = null ) {
	global $wpdb;
