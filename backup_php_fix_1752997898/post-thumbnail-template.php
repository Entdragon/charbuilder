 ...
 */
function CG_Dev\\has_post_thumbnail( $post = null ) {
 ...
 */
function CG_Dev\\get_post_thumbnail_id( $post = null ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\the_post_thumbnail( $size = 'post-thumbnail', $attr = '' ) {
 ...
 */
function CG_Dev\\update_post_thumbnail_cache( $wp_query = null ) {
	if ( ! $wp_query ) {
 ...
 */
function CG_Dev\\get_the_post_thumbnail( $post = null, $size = 'post-thumbnail', $attr = '' ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\get_the_post_thumbnail_url( $post = null, $size = 'post-thumbnail' ) {
	$post_thumbnail_id = get_post_thumbnail_id( $post );
 ...
 */
function CG_Dev\\the_post_thumbnail_url( $size = 'post-thumbnail' ) {
 ...
 */
function CG_Dev\\get_the_post_thumbnail_caption( $post = null ) {
	$post_thumbnail_id = get_post_thumbnail_id( $post );
 ...
 * @param int|WP_Post|null $post Optional. Post ID or WP_Post object. Default is global `$post`.
 */
function CG_Dev\\the_post_thumbnail_caption( $post = null ) {
	/**
