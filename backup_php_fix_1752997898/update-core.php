 ...
 */
function CG_Dev\\update_core( $from, $to ) {
 ...
 * @param string $to Path to old WordPress installation.
 */
function CG_Dev\\_preload_old_requests_classes_and_interfaces( $to ) {
 ...
 */
function CG_Dev\\_redirect_to_about_wordpress( $new_version ) {
 ...
 */
function CG_Dev\\_upgrade_422_remove_genericons() {
 ...
 * @return string[]
 */
function CG_Dev\\_upgrade_422_find_genericons_files_in_folder( $directory ) {
 ...
 * @since 4.4.0
 */
function CG_Dev\\_upgrade_440_force_deactivate_incompatible_plugins() {
 ...
 */
function CG_Dev\\_upgrade_core_deactivate_incompatible_plugins() {
