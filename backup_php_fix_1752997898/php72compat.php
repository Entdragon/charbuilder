...
if (!is_callable('sodium_base642bin')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_base642bin(
        #[\SensitiveParameter]
        $string,
        $variant,
        $ignore =''
...
if (!is_callable('sodium_bin2base64')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_bin2base64(
        #[\SensitiveParameter]
        $string,
        $variant
    ) {
...
if (!is_callable('sodium_bin2hex')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_bin2hex(
        #[\SensitiveParameter]
        $string
    ) {
...
if (!is_callable('sodium_compare')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_compare(
        #[\SensitiveParameter]
        $string1,
        #[\SensitiveParameter]
        $string2
...
if (!is_callable('sodium_crypto_aead_aes256gcm_decrypt')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\sodium_crypto_aead_aes256gcm_decrypt(
        $ciphertext,
        $additional_data,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_aead_aes256gcm_encrypt')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_aead_aes256gcm_encrypt(
        #[\SensitiveParameter]
        $message,
        $additional_data,
        $nonce,
...
if (!is_callable('sodium_crypto_aead_aes256gcm_is_available')) {
     ...
     * @return bool
     */
    function CG_Dev\\sodium_crypto_aead_aes256gcm_is_available()
    {
...
if (!is_callable('sodium_crypto_aead_chacha20poly1305_decrypt')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\sodium_crypto_aead_chacha20poly1305_decrypt(
        $ciphertext,
        $additional_data,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_aead_chacha20poly1305_encrypt')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_aead_chacha20poly1305_encrypt(
        #[\SensitiveParameter]
        $message,
        $additional_data,
        $nonce,
...
if (!is_callable('sodium_crypto_aead_chacha20poly1305_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_aead_chacha20poly1305_keygen()
    {
...
if (!is_callable('sodium_crypto_aead_chacha20poly1305_ietf_decrypt')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\sodium_crypto_aead_chacha20poly1305_ietf_decrypt(
        $message,
        $additional_data,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_aead_chacha20poly1305_ietf_encrypt')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_aead_chacha20poly1305_ietf_encrypt(
        #[\SensitiveParameter]
        $message,
        $additional_data,
        $nonce,
...
if (!is_callable('sodium_crypto_aead_chacha20poly1305_ietf_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_aead_chacha20poly1305_ietf_keygen()
    {
...
if (!is_callable('sodium_crypto_aead_xchacha20poly1305_ietf_decrypt')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\sodium_crypto_aead_xchacha20poly1305_ietf_decrypt(
        $ciphertext,
        $additional_data,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_aead_xchacha20poly1305_ietf_encrypt')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_aead_xchacha20poly1305_ietf_encrypt(
        #[\SensitiveParameter]
        $message,
        $additional_data,
        $nonce,
...
if (!is_callable('sodium_crypto_aead_xchacha20poly1305_ietf_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_aead_xchacha20poly1305_ietf_keygen()
    {
...
if (!is_callable('sodium_crypto_auth')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_auth(
        $message,
        #[\SensitiveParameter]
        $key
    ) {
...
if (!is_callable('sodium_crypto_auth_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_auth_keygen()
    {
...
if (!is_callable('sodium_crypto_auth_verify')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_auth_verify(
        $mac,
        $message,
        #[\SensitiveParameter]
        $key
...
if (!is_callable('sodium_crypto_box')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box(
        #[\SensitiveParameter]
        $message,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_box_keypair')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box_keypair()
    {
...
if (!is_callable('sodium_crypto_box_keypair_from_secretkey_and_publickey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box_keypair_from_secretkey_and_publickey(
        #[\SensitiveParameter]
        $secret_key,
        $public_key
    ) {
...
if (!is_callable('sodium_crypto_box_open')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\sodium_crypto_box_open(
        $ciphertext,
        $nonce,
        #[\SensitiveParameter]
        $key_pair
...
if (!is_callable('sodium_crypto_box_publickey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box_publickey(
        #[\SensitiveParameter]
        $key_pair
    ) {
...
if (!is_callable('sodium_crypto_box_publickey_from_secretkey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box_publickey_from_secretkey(
        #[\SensitiveParameter]
        $secret_key
    ) {
...
if (!is_callable('sodium_crypto_box_seal')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box_seal(
        #[\SensitiveParameter]
        $message,
        $public_key
    ) {
...
if (!is_callable('sodium_crypto_box_seal_open')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_box_seal_open(
        $message,
        #[\SensitiveParameter]
        $key_pair
    ) {
...
if (!is_callable('sodium_crypto_box_secretkey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box_secretkey(
        #[\SensitiveParameter]
        $key_pair
    ) {
...
if (!is_callable('sodium_crypto_box_seed_keypair')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_box_seed_keypair(
        #[\SensitiveParameter]
        $seed
    ) {
...
if (!is_callable('sodium_crypto_generichash')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_generichash(
        $message,
        #[\SensitiveParameter]
        $key = null,
        $length = 32
...
if (!is_callable('sodium_crypto_generichash_final')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_generichash_final(&$state, $outputLength = 32)
    {
...
if (!is_callable('sodium_crypto_generichash_init')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_generichash_init(
        #[\SensitiveParameter]
        $key = null,
        $length = 32
    ) {
...
if (!is_callable('sodium_crypto_generichash_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_generichash_keygen()
    {
...
if (!is_callable('sodium_crypto_generichash_update')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_generichash_update(
        #[\SensitiveParameter]
        &$state,
        $message = ''
    ) {
...
if (!is_callable('sodium_crypto_kdf_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_kdf_keygen()
    {
...
if (!is_callable('sodium_crypto_kdf_derive_from_key')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_kdf_derive_from_key(
        $subkey_length,
        $subkey_id,
        $context,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_kx')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_kx(
        #[\SensitiveParameter]
        $my_secret,
        $their_public,
        $client_public,
...
if (!is_callable('sodium_crypto_kx_seed_keypair')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_kx_seed_keypair(
        #[\SensitiveParameter]
        $seed
    ) {
...
if (!is_callable('sodium_crypto_kx_keypair')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_kx_keypair()
    {
...
if (!is_callable('sodium_crypto_kx_client_session_keys')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_kx_client_session_keys(
        #[\SensitiveParameter]
        $client_key_pair,
        $server_key
    ) {
...
if (!is_callable('sodium_crypto_kx_server_session_keys')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_kx_server_session_keys(
        #[\SensitiveParameter]
        $server_key_pair,
        $client_key
    ) {
...
if (!is_callable('sodium_crypto_kx_secretkey')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_kx_secretkey(
        #[\SensitiveParameter]
        $key_pair
    ) {
...
if (!is_callable('sodium_crypto_kx_publickey')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_kx_publickey(
        #[\SensitiveParameter]
        $key_pair
    ) {
...
if (!is_callable('sodium_crypto_pwhash')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_pwhash(
        $length,
        #[\SensitiveParameter]
        $passwd,
        $salt,
...
if (!is_callable('sodium_crypto_pwhash_str')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_pwhash_str(
        #[\SensitiveParameter]
        $passwd,
        $opslimit,
        $memlimit
...
if (!is_callable('sodium_crypto_pwhash_str_needs_rehash')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_pwhash_str_needs_rehash(
        #[\SensitiveParameter]
        $hash,
        $opslimit,
        $memlimit
...
if (!is_callable('sodium_crypto_pwhash_str_verify')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_pwhash_str_verify(
        #[\SensitiveParameter]
        $passwd,
        #[\SensitiveParameter]
        $hash
...
if (!is_callable('sodium_crypto_pwhash_scryptsalsa208sha256')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_pwhash_scryptsalsa208sha256(
        $length,
        #[\SensitiveParameter]
        $passwd,
        $salt,
...
if (!is_callable('sodium_crypto_pwhash_scryptsalsa208sha256_str')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_pwhash_scryptsalsa208sha256_str(
        #[\SensitiveParameter]
        $passwd,
        $opslimit,
        $memlimit
...
if (!is_callable('sodium_crypto_pwhash_scryptsalsa208sha256_str_verify')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_pwhash_scryptsalsa208sha256_str_verify(
        #[\SensitiveParameter]
        $passwd,
        #[\SensitiveParameter]
        $hash
...
if (!is_callable('sodium_crypto_scalarmult')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_scalarmult(
        #[\SensitiveParameter]
        $n,
        $p
    ) {
...
if (!is_callable('sodium_crypto_scalarmult_base')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_scalarmult_base(
        #[\SensitiveParameter]
        $n
    ) {
...
if (!is_callable('sodium_crypto_secretbox')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_secretbox(
        #[\SensitiveParameter]
        $message,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_secretbox_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_secretbox_keygen()
    {
...
if (!is_callable('sodium_crypto_secretbox_open')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\sodium_crypto_secretbox_open(
        $ciphertext,
        $nonce,
        #[\SensitiveParameter]
        $key
...
if (!is_callable('sodium_crypto_secretstream_xchacha20poly1305_init_push')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_secretstream_xchacha20poly1305_init_push(
        #[\SensitiveParameter]
        $key
    ) {
...
if (!is_callable('sodium_crypto_secretstream_xchacha20poly1305_push')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_secretstream_xchacha20poly1305_push(
        #[\SensitiveParameter]
        &$state,
        #[\SensitiveParameter]
        $message,
...
if (!is_callable('sodium_crypto_secretstream_xchacha20poly1305_init_pull')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_secretstream_xchacha20poly1305_init_pull(
        $header,
        #[\SensitiveParameter]
        $key
    ) {
...
if (!is_callable('sodium_crypto_secretstream_xchacha20poly1305_pull')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_secretstream_xchacha20poly1305_pull(
        #[\SensitiveParameter]
        &$state,
        $ciphertext,
        $additional_data = ''
...
if (!is_callable('sodium_crypto_secretstream_xchacha20poly1305_rekey')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_secretstream_xchacha20poly1305_rekey(
        #[\SensitiveParameter]
        &$state
    ) {
...
if (!is_callable('sodium_crypto_secretstream_xchacha20poly1305_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_secretstream_xchacha20poly1305_keygen()
    {
...
if (!is_callable('sodium_crypto_shorthash')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_shorthash(
        $message,
        #[\SensitiveParameter]
        $key = ''
    ) {
...
if (!is_callable('sodium_crypto_shorthash_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_shorthash_keygen()
    {
...
if (!is_callable('sodium_crypto_sign')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign(
        $message,
        #[\SensitiveParameter]
        $secret_key
    ) {
...
if (!is_callable('sodium_crypto_sign_detached')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_detached(
        $message,
        #[\SensitiveParameter]
        $secret_key
    ) {
...
if (!is_callable('sodium_crypto_sign_keypair_from_secretkey_and_publickey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_keypair_from_secretkey_and_publickey(
        #[\SensitiveParameter]
        $secret_key,
        $public_key
    ) {
...
if (!is_callable('sodium_crypto_sign_keypair')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_keypair()
    {
...
if (!is_callable('sodium_crypto_sign_open')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\sodium_crypto_sign_open($signedMessage, $public_key)
    {
        try {
...
if (!is_callable('sodium_crypto_sign_publickey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_publickey(
        #[\SensitiveParameter]
        $key_pair
    ) {
...
if (!is_callable('sodium_crypto_sign_publickey_from_secretkey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_publickey_from_secretkey(
        #[\SensitiveParameter]
        $secret_key
    ) {
...
if (!is_callable('sodium_crypto_sign_secretkey')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_secretkey(
        #[\SensitiveParameter]
        $key_pair
    ) {
...
if (!is_callable('sodium_crypto_sign_seed_keypair')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_seed_keypair(
        #[\SensitiveParameter]
        $seed
    ) {
...
if (!is_callable('sodium_crypto_sign_verify_detached')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_verify_detached($signature, $message, $public_key)
    {
...
if (!is_callable('sodium_crypto_sign_ed25519_pk_to_curve25519')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_ed25519_pk_to_curve25519($public_key)
    {
...
if (!is_callable('sodium_crypto_sign_ed25519_sk_to_curve25519')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_sign_ed25519_sk_to_curve25519(
        #[\SensitiveParameter]
        $secret_key
    ) {
...
if (!is_callable('sodium_crypto_stream')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_stream(
        $length,
        $nonce,
        #[\SensitiveParameter]
        $key
...
if (!is_callable('sodium_crypto_stream_keygen')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_crypto_stream_keygen()
    {
...
if (!is_callable('sodium_crypto_stream_xor')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_stream_xor(
        #[\SensitiveParameter]
        $message,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_hex2bin')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_hex2bin(
        #[\SensitiveParameter]
        $string,
        $ignore = ''
    ) {
...
if (!is_callable('sodium_increment')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_increment(
        #[\SensitiveParameter]
        &$string
    ) {
...
if (!is_callable('sodium_library_version_major')) {
     ...
     * @return int
     */
    function CG_Dev\\sodium_library_version_major()
    {
...
if (!is_callable('sodium_library_version_minor')) {
     ...
     * @return int
     */
    function CG_Dev\\sodium_library_version_minor()
    {
...
if (!is_callable('sodium_version_string')) {
     ...
     * @return string
     */
    function CG_Dev\\sodium_version_string()
    {
...
if (!is_callable('sodium_memzero')) {
     ...
     */
    function CG_Dev\\sodium_memzero(
        #[\SensitiveParameter]
        &$string
    ) {
...
if (!is_callable('sodium_randombytes_buf')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_randombytes_buf($amount)
    {
...
if (!is_callable('sodium_randombytes_uniform')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_randombytes_uniform($upperLimit)
    {
...
if (!is_callable('sodium_randombytes_random16')) {
     ...
     * @throws Exception
     */
    function CG_Dev\\sodium_randombytes_random16()
    {
