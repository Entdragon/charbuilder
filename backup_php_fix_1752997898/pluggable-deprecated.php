 ...
 */
function CG_Dev\\set_current_user($id, $name = '') {
 ...
 */
function CG_Dev\\get_currentuserinfo() {
 ...
 */
function CG_Dev\\get_userdatabylogin($user_login) {
 ...
 * @return bool|object False on failure, User DB row object
 */
function CG_Dev\\get_user_by_email($email) {
 ...
 */
function CG_Dev\\wp_clearcookie() {
 ...
 */
function CG_Dev\\wp_get_cookie_login() {
