 ...
 * }
 */
function CG_Dev\\translations_api( $type, $args = null ) {
 ...
 * }
 */
function CG_Dev\\wp_get_available_translations() {
	if ( ! wp_installing() ) {
 ...
 */
function CG_Dev\\wp_install_language_form( $languages ) {
 ...
 */
function CG_Dev\\wp_download_language_pack( $download ) {
 ...
 */
function CG_Dev\\wp_can_install_language_pack() {
