 ...
 * @return int
 */
function CG_Dev\\_usort_by_first_member( $a, $b ) {
 ...
 */
function CG_Dev\\register_importer( $id, $name, $description, $callback ) {
	global $wp_importers;
 ...
 */
function CG_Dev\\wp_import_cleanup( $id ) {
 ...
 */
function CG_Dev\\wp_import_handle_upload() {
 ...
 */
function CG_Dev\\wp_get_popular_importers() {
