 ...
 */
function CG_Dev\\get_default_block_categories() {
	return array(
		array(
			'slug'  => 'text',
 ...
 * @return array[] Array of categories for block types.
 */
function CG_Dev\\get_block_categories( $post_or_block_editor_context ) {
 ...
 */
function CG_Dev\\get_allowed_block_types( $block_editor_context ) {
 ...
 */
function CG_Dev\\get_default_block_editor_settings() {
	// Media settings.
 ...
 */
function CG_Dev\\get_legacy_widget_block_editor_settings() {
	$editor_settings = array();
 ...
 * }
 */
function CG_Dev\\_wp_get_iframed_editor_assets() {
 ...
 */
function CG_Dev\\wp_get_first_block( $blocks, $block_name ) {
 ...
 */
function CG_Dev\\wp_get_post_content_block_attributes() {
	global $post_ID;
 ...
 */
function CG_Dev\\get_block_editor_settings( array $custom_settings, $block_editor_context ) {
 ...
 * @param WP_Block_Editor_Context $block_editor_context The current block editor context.
 */
function CG_Dev\\block_editor_rest_api_preload( array $preload_paths, $block_editor_context ) {
 ...
 */
function CG_Dev\\get_block_editor_theme_styles() {
 ...
 */
function CG_Dev\\get_classic_theme_supports_block_editor_settings() {
 ...
 * @since 6.8.0
 */
function CG_Dev\\wp_initialize_site_preview_hooks() {
	if (
