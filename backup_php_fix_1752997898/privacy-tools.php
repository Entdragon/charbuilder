 ...
 */
function CG_Dev\\_wp_privacy_resend_request( $request_id ) {
 ...
 */
function CG_Dev\\_wp_privacy_completed_request( $request_id ) {
	// Get the request.
	$request_id = absint( $request_id );
 ...
 * @access private
 */
function CG_Dev\\_wp_personal_data_handle_actions() {
 ...
 * @access private
 */
function CG_Dev\\_wp_personal_data_cleanup_requests() {
 ...
 */
function CG_Dev\\wp_privacy_generate_personal_data_export_group_html( $group_data, $group_id = '', $groups_count = 1 ) {
 ...
 */
function CG_Dev\\wp_privacy_generate_personal_data_export_file( $request_id ) {
 ...
 */
function CG_Dev\\wp_privacy_send_personal_data_export_email( $request_id ) {
	// Get the request.
	$request = wp_get_user_request( $request_id );
 ...
 */
function CG_Dev\\wp_privacy_process_personal_data_export_page( $response, $exporter_index, $email_address, $page, $request_id, $send_as_email, $exporter_key ) {
 ...
 * @return array The filtered response.
 */
function CG_Dev\\wp_privacy_process_personal_data_erasure_page( $response, $eraser_index, $email_address, $page, $request_id ) {
	/*
