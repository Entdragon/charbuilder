 ...
 */
function CG_Dev\\wp_get_global_settings( $path = array(), $context = array() ) {
 ...
 */
function CG_Dev\\wp_get_global_styles( $path = array(), $context = array() ) {
	if ( ! empty( $context['block_name'] ) ) {
 ...
 */
function CG_Dev\\wp_get_global_stylesheet( $types = array() ) {
	/*
	 * Ignore cache when the development mode is set to 'theme', so it doesn't interfere with the theme
	 * developer's workflow.
	 */
 ...
 */
function CG_Dev\\wp_add_global_styles_for_blocks() {
	global $wp_styles;
 ...
 */
function CG_Dev\\wp_get_block_name_from_theme_json_path( $path ) {
 ...
 */
function CG_Dev\\wp_theme_has_theme_json() {
 ...
 * @since 6.2.0
 */
function CG_Dev\\wp_clean_theme_json_cache() {
 ...
 * @return string[]
 */
function CG_Dev\\wp_get_theme_directory_pattern_slugs() {
 ...
 */
function CG_Dev\\wp_get_theme_data_custom_templates() {
 ...
 */
function CG_Dev\\wp_get_theme_data_template_parts() {
	$cache_group    = 'theme_json';
 ...
 */
function CG_Dev\\wp_get_block_css_selector( $block_type, $target = 'root', $fallback = false ) {
	if ( empty( $target ) ) {
		return null;
	}
