 ...
 */
function CG_Dev\\get_preferred_from_update_core() {
 ...
 */
function CG_Dev\\get_core_updates( $options = array() ) {
	$options = array_merge(
		array(
			'available' => true,
			'dismissed' => false,
 ...
 */
function CG_Dev\\find_core_auto_update() {
 ...
 */
function CG_Dev\\get_core_checksums( $version, $locale ) {
 ...
 * @return bool
 */
function CG_Dev\\dismiss_core_update( $update ) {
	$dismissed = get_site_option( 'dismissed_update_core' );
 ...
 * @return bool
 */
function CG_Dev\\undismiss_core_update( $version, $locale ) {
	$dismissed = get_site_option( 'dismissed_update_core' );
	$key       = $version . '|' . $locale;
 ...
 * @return object|false The core update offering on success, false on failure.
 */
function CG_Dev\\find_core_update( $version, $locale ) {
	$from_api = get_site_transient( 'update_core' );
 ...
 * @return string
 */
function CG_Dev\\core_update_footer( $msg = '' ) {
 ...
 * @since 2.5.0
 */
function CG_Dev\\update_right_now_message() {
 ...
 * @return object[]
 */
function CG_Dev\\get_plugin_updates() {
 ...
 * @since 2.9.0
 */
function CG_Dev\\wp_plugin_update_rows() {
 ...
 * @return void|false
 */
function CG_Dev\\wp_plugin_update_row( $file, $plugin_data ) {
	$current = get_site_transient( 'update_plugins' );
 ...
 * @return WP_Theme[]
 */
function CG_Dev\\get_theme_updates() {
 ...
 * @since 3.1.0
 */
function CG_Dev\\wp_theme_update_rows() {
 ...
 * @return void|false
 */
function CG_Dev\\wp_theme_update_row( $theme_key, $theme ) {
	$current = get_site_transient( 'update_themes' );
 ...
 * @return void|false
 */
function CG_Dev\\maintenance_nag() {
	global $upgrading;
 ...
 *     }
 */
function CG_Dev\\wp_print_admin_notice_templates() {
	?>
 ...
 *     }
 */
function CG_Dev\\wp_print_update_row_templates() {
	?>
 ...
 * @since 5.2.0
 */
function CG_Dev\\wp_recovery_mode_nag() {
 ...
 */
function CG_Dev\\wp_is_auto_update_enabled_for_type( $type ) {
 ...
 */
function CG_Dev\\wp_is_auto_update_forced_for_item( $type, $update, $item ) {
 ...
 */
function CG_Dev\\wp_get_auto_update_message() {
