 ...
 * @return array
 */
function CG_Dev\\install_themes_feature_list() {
 ...
 */
function CG_Dev\\install_theme_search_form( $type_selector = true ) {
 ...
 * @since 2.8.0
 */
function CG_Dev\\install_themes_dashboard() {
 ...
 * @since 2.8.0
 */
function CG_Dev\\install_themes_upload() {
	?>
 ...
 * @param object $theme
 */
function CG_Dev\\display_theme( $theme ) {
 ...
 * @global WP_Theme_Install_List_Table $wp_list_table
 */
function CG_Dev\\display_themes() {
	global $wp_list_table;
 ...
 * @global WP_Theme_Install_List_Table $wp_list_table
 */
function CG_Dev\\install_theme_information() {
	global $wp_list_table;
