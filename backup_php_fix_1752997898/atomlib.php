...
class AtomParser {
    ...
    function CG_Dev\\_p($msg) {
        if($this->debug) {
            print str_repeat(" ", $this->depth * $this->indent) . $msg ."\n";
        }
    }

    function CG_Dev\\error_handler($log_level, $log_text, $error_file, $error_line) {
        $this->error = $log_text;
    }

    function CG_Dev\\parse() {
    ...
    function CG_Dev\\start_element($parser, $name, $attrs) {
    ...
    function CG_Dev\\end_element($parser, $name) {
    ...
    function CG_Dev\\start_ns($parser, $prefix, $uri) {
        $this->_p("starting: " . $prefix . ":" . $uri);
        array_push($this->ns_decls, array($prefix,$uri));
    }

    function CG_Dev\\end_ns($parser, $prefix) {
        $this->_p("ending: #" . $prefix . "#");
    }

    function CG_Dev\\cdata($parser, $data) {
    ...
    function CG_Dev\\_default($parser, $data) {
        # when does this gets called?
    }


    function CG_Dev\\ns_to_prefix($qname, $attr=false) {
    ...
    function CG_Dev\\is_declared_content_ns($new_mapping) {
    ...
    function CG_Dev\\xml_escape($content)
    {
