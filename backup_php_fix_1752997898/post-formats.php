 ...
 */
function CG_Dev\\get_post_format( $post = null ) {
	$post = get_post( $post );
 ...
 *              false otherwise.
 */
function CG_Dev\\has_post_format( $format = array(), $post = null ) {
	$prefixed = array();
 ...
 */
function CG_Dev\\set_post_format( $post, $format ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\get_post_format_strings() {
	$strings = array(
 ...
 */
function CG_Dev\\get_post_format_slugs() {
 ...
 */
function CG_Dev\\get_post_format_string( $slug ) {
 ...
 */
function CG_Dev\\get_post_format_link( $format ) {
 ...
 * @return array
 */
function CG_Dev\\_post_format_request( $qvs ) {
 ...
 * @return string
 */
function CG_Dev\\_post_format_link( $link, $term, $taxonomy ) {
	global $wp_rewrite;
 ...
 * @return object
 */
function CG_Dev\\_post_format_get_term( $term ) {
	if ( isset( $term->slug ) ) {
 ...
 * @return array
 */
function CG_Dev\\_post_format_get_terms( $terms, $taxonomies, $args ) {
 ...
 * @return array
 */
function CG_Dev\\_post_format_wp_get_object_terms( $terms ) {
	foreach ( (array) $terms as $order => $term ) {
		if ( isset( $term->taxonomy ) && 'post_format' === $term->taxonomy ) {
			$terms[ $order ]->name = get_post_format_string( str_replace( 'post-format-', '', $term->slug ) );
		}
