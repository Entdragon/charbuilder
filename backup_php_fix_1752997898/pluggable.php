...
if ( ! function_exists( 'wp_set_current_user' ) ) :
	 ...
	 */
	function CG_Dev\\wp_set_current_user( $id, $name = '' ) {
		global $current_user;
...
if ( ! function_exists( 'wp_get_current_user' ) ) :
	 ...
	 */
	function CG_Dev\\wp_get_current_user() {
...
if ( ! function_exists( 'get_userdata' ) ) :
	 ...
	 */
	function CG_Dev\\get_userdata( $user_id ) {
...
if ( ! function_exists( 'get_user_by' ) ) :
	 ...
	 * @return WP_User|false WP_User object on success, false on failure.
	 */
	function CG_Dev\\get_user_by( $field, $value ) {
...
if ( ! function_exists( 'cache_users' ) ) :
	 ...
	 */
	function CG_Dev\\cache_users( $user_ids ) {
		global $wpdb;
...
if ( ! function_exists( 'wp_mail' ) ) :
	 ...
	 */
	function CG_Dev\\wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
...
if ( ! function_exists( 'wp_authenticate' ) ) :
	 ...
	 *                          otherwise WP_Error.
	 */
	function CG_Dev\\wp_authenticate(
		$username,
		#[\SensitiveParameter]
		$password
	) {
...
if ( ! function_exists( 'wp_validate_auth_cookie' ) ) :
	 ...
	 */
	function CG_Dev\\wp_validate_auth_cookie( $cookie = '', $scheme = '' ) {
...
if ( ! function_exists( 'wp_generate_auth_cookie' ) ) :
	 ...
	 */
	function CG_Dev\\wp_generate_auth_cookie( $user_id, $expiration, $scheme = 'auth', $token = '' ) {
...
if ( ! function_exists( 'wp_parse_auth_cookie' ) ) :
	 ...
	 * }
	 */
	function CG_Dev\\wp_parse_auth_cookie( $cookie = '', $scheme = '' ) {
		if ( empty( $cookie ) ) {
			switch ( $scheme ) {
				case 'auth':
...
if ( ! function_exists( 'wp_set_auth_cookie' ) ) :
	 ...
	 */
	function CG_Dev\\wp_set_auth_cookie( $user_id, $remember = false, $secure = '', $token = '' ) {
		if ( $remember ) {
			/**
...
if ( ! function_exists( 'wp_clear_auth_cookie' ) ) :
	 ...
	 * @since 2.5.0
	 */
	function CG_Dev\\wp_clear_auth_cookie() {
		/**
...
if ( ! function_exists( 'is_user_logged_in' ) ) :
	 ...
	 */
	function CG_Dev\\is_user_logged_in() {
...
if ( ! function_exists( 'check_admin_referer' ) ) :
	 ...
	 */
	function CG_Dev\\check_admin_referer( $action = -1, $query_arg = '_wpnonce' ) {
		if ( -1 === $action ) {
...
if ( ! function_exists( 'check_ajax_referer' ) ) :
	 ...
	 *                   False if the nonce is invalid.
	 */
	function CG_Dev\\check_ajax_referer( $action = -1, $query_arg = false, $stop = true ) {
		if ( -1 === $action ) {
...
if ( ! function_exists( 'wp_redirect' ) ) :
	 ...
	 */
	function CG_Dev\\wp_redirect( $location, $status = 302, $x_redirect_by = 'WordPress' ) {
		global $is_IIS;
...
if ( ! function_exists( 'wp_sanitize_redirect' ) ) :
	 ...
	 */
	function CG_Dev\\wp_sanitize_redirect( $location ) {
		// Encode spaces.
	 ...
	 */
	function CG_Dev\\_wp_sanitize_utf8_in_redirect( $matches ) {
...
if ( ! function_exists( 'wp_safe_redirect' ) ) :
	 ...
	 * @return bool False if the redirect was canceled, true otherwise.
	 */
	function CG_Dev\\wp_safe_redirect( $location, $status = 302, $x_redirect_by = 'WordPress' ) {
...
if ( ! function_exists( 'wp_validate_redirect' ) ) :
	 ...
	 * @return string Redirect-sanitized URL.
	 */
	function CG_Dev\\wp_validate_redirect( $location, $fallback_url = '' ) {
...
if ( ! function_exists( 'wp_notify_postauthor' ) ) :
	 ...
	 */
	function CG_Dev\\wp_notify_postauthor( $comment_id, $deprecated = null ) {
		if ( null !== $deprecated ) {
...
if ( ! function_exists( 'wp_notify_moderator' ) ) :
	 ...
	 */
	function CG_Dev\\wp_notify_moderator( $comment_id ) {
		global $wpdb;
...
if ( ! function_exists( 'wp_password_change_notification' ) ) :
	 ...
	 * @param WP_User $user User object.
	 */
	function CG_Dev\\wp_password_change_notification( $user ) {
		/*
...
if ( ! function_exists( 'wp_new_user_notification' ) ) :
	 ...
	 */
	function CG_Dev\\wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
		if ( null !== $deprecated ) {
...
if ( ! function_exists( 'wp_nonce_tick' ) ) :
	 ...
	 */
	function CG_Dev\\wp_nonce_tick( $action = -1 ) {
		/**
...
if ( ! function_exists( 'wp_verify_nonce' ) ) :
	 ...
	 *                   False if the nonce is invalid.
	 */
	function CG_Dev\\wp_verify_nonce( $nonce, $action = -1 ) {
		$nonce = (string) $nonce;
		$user  = wp_get_current_user();
		$uid   = (int) $user->ID;
		if ( ! $uid ) {
...
if ( ! function_exists( 'wp_create_nonce' ) ) :
	 ...
	 */
	function CG_Dev\\wp_create_nonce( $action = -1 ) {
		$user = wp_get_current_user();
		$uid  = (int) $user->ID;
		if ( ! $uid ) {
			/** This filter is documented in wp-includes/pluggable.php */
...
if ( ! function_exists( 'wp_salt' ) ) :
	 ...
	 */
	function CG_Dev\\wp_salt( $scheme = 'auth' ) {
...
if ( ! function_exists( 'wp_hash' ) ) :
	 ...
	 */
	function CG_Dev\\wp_hash( $data, $scheme = 'auth', $algo = 'md5' ) {
		$salt = wp_salt( $scheme );
...
if ( ! function_exists( 'wp_hash_password' ) ) :
	 ...
	 */
	function CG_Dev\\wp_hash_password(
		#[\SensitiveParameter]
		$password
	) {
		global $wp_hasher;
...
if ( ! function_exists( 'wp_check_password' ) ) :
	 ...
	 */
	function CG_Dev\\wp_check_password(
		#[\SensitiveParameter]
		$password,
		$hash,
		$user_id = ''
...
if ( ! function_exists( 'wp_password_needs_rehash' ) ) :
	 ...
	 */
	function CG_Dev\\wp_password_needs_rehash( $hash, $user_id = '' ) {
		global $wp_hasher;
...
if ( ! function_exists( 'wp_generate_password' ) ) :
	 ...
	 */
	function CG_Dev\\wp_generate_password( $length = 12, $special_chars = true, $extra_special_chars = false ) {
...
if ( ! function_exists( 'wp_rand' ) ) :
	 ...
	 */
	function CG_Dev\\wp_rand( $min = null, $max = null ) {
		global $rnd_value;
...
if ( ! function_exists( 'wp_set_password' ) ) :
	 ...
	 * @param int    $user_id  User ID.
	 */
	function CG_Dev\\wp_set_password(
		#[\SensitiveParameter]
		$password,
		$user_id
	) {
...
if ( ! function_exists( 'get_avatar' ) ) :
	 ...
	 */
	function CG_Dev\\get_avatar( $id_or_email, $size = 96, $default_value = '', $alt = '', $args = null ) {
		$defaults = array(
...
if ( ! function_exists( 'wp_text_diff' ) ) :
	 ...
	 */
	function CG_Dev\\wp_text_diff( $left_string, $right_string, $args = null ) {
		$defaults = array(
			'title'           => '',
			'title_left'      => '',
			'title_right'     => '',
