 ...
 */
function CG_Dev\\wp_get_server_protocol() {
 ...
 */
function CG_Dev\\wp_fix_server_vars() {
	global $PHP_SELF;
 ...
 * @since 5.6.0
 */
function CG_Dev\\wp_populate_basic_auth_from_authorization_header() {
 ...
 */
function CG_Dev\\wp_check_php_mysql_versions() {
 ...
 */
function CG_Dev\\wp_get_environment_type() {
	static $current_env = '';
 ...
 */
function CG_Dev\\wp_get_development_mode() {
 ...
 */
function CG_Dev\\wp_is_development_mode( $mode ) {
 ...
 */
function CG_Dev\\wp_favicon_request() {
 ...
 * @access private
 */
function CG_Dev\\wp_maintenance() {
 ...
 */
function CG_Dev\\wp_is_maintenance_mode() {
	global $upgrading;
 ...
 */
function CG_Dev\\timer_stop( $display = 0, $precision = 3 ) {
 ...
 * @access private
 */
function CG_Dev\\wp_set_lang_dir() {
 ...
 */
function CG_Dev\\wp_set_wpdb_vars() {
 ...
 */
function CG_Dev\\wp_using_ext_object_cache( $using = null ) {
 ...
 */
function CG_Dev\\wp_start_object_cache() {
	global $wp_filter;
 ...
 * @access private
 */
function CG_Dev\\wp_not_installed() {
 ...
 */
function CG_Dev\\wp_get_mu_plugins() {
	$mu_plugins = array();
 ...
 */
function CG_Dev\\wp_get_active_and_valid_plugins() {
	$plugins        = array();
 ...
 */
function CG_Dev\\wp_skip_paused_plugins( array $plugins ) {
 ...
 */
function CG_Dev\\wp_get_active_and_valid_themes() {
 ...
 */
function CG_Dev\\wp_skip_paused_themes( array $themes ) {
 ...
 * @return bool
 */
function CG_Dev\\wp_is_recovery_mode() {
 ...
 */
function CG_Dev\\is_protected_endpoint() {
	// Protect login pages.
 ...
 */
function CG_Dev\\is_protected_ajax_action() {
	if ( ! wp_doing_ajax() ) {
		return false;
	}
 ...
 * @access private
 */
function CG_Dev\\wp_set_internal_encoding() {
 ...
 * @access private
 */
function CG_Dev\\wp_magic_quotes() {
	// Escape with wpdb.
 ...
 * @access private
 */
function CG_Dev\\shutdown_action_hook() {
	/**
 ...
 */
function CG_Dev\\wp_clone( $input_object ) {
 ...
 */
function CG_Dev\\is_network_admin() {
	if ( isset( $GLOBALS['current_screen'] ) ) {
 ...
 */
function CG_Dev\\absint( $maybeint ) {
 ...
 * @return int Site ID.
 */
function CG_Dev\\get_current_blog_id() {
	global $blog_id;
 ...
 */
function CG_Dev\\get_current_network_id() {
	if ( ! is_multisite() ) {
		return 1;
	}
 ...
 */
function CG_Dev\\wp_load_translations_early() {
 ...
 */
function CG_Dev\\wp_installing( $is_installing = null ) {
 ...
 */
function CG_Dev\\wp_convert_hr_to_bytes( $value ) {
 ...
 */
function CG_Dev\\wp_is_ini_value_changeable( $setting ) {
	static $ini_all;
 ...
 */
function CG_Dev\\wp_using_themes() {
	/**
 ...
 */
function CG_Dev\\is_wp_error( $thing ) {
 ...
 */
function CG_Dev\\wp_is_file_mod_allowed( $context ) {
	/**
 ...
 * @since 4.9.0
 */
function CG_Dev\\wp_start_scraping_edited_file_errors() {
 ...
 */
function CG_Dev\\wp_finalize_scraping_edited_file_errors( $scrape_key ) {
 ...
 *              False otherwise.
 */
function CG_Dev\\wp_is_json_request() {
 ...
 */
function CG_Dev\\wp_is_jsonp_request() {
 ...
 */
function CG_Dev\\wp_is_json_media_type( $media_type ) {
	static $cache = array();
 ...
 */
function CG_Dev\\wp_is_xml_request() {
	$accepted = array(
		'text/xml',
		'application/rss+xml',
 ...
 */
function CG_Dev\\wp_is_site_protected_by_basic_auth( $context = '' ) {
	global $pagenow;
