 ...
 */
function CG_Dev\\plugins_api( $action, $args = array() ) {
	if ( is_array( $args ) ) {
		$args = (object) $args;
	}
 ...
 */
function CG_Dev\\install_popular_tags( $args = array() ) {
 ...
 * @since 2.7.0
 */
function CG_Dev\\install_dashboard() {
 ...
 */
function CG_Dev\\install_search_form( $deprecated = true ) {
 ...
 * @since 2.8.0
 */
function CG_Dev\\install_plugins_upload() {
	?>
 ...
 * @since 3.5.0
 */
function CG_Dev\\install_plugins_favorites_form() {
 ...
 */
function CG_Dev\\display_plugins_table() {
 ...
 * }
 */
function CG_Dev\\install_plugin_install_status( $api, $loop = false ) {
 ...
 * @global string $tab
 */
function CG_Dev\\install_plugin_information() {
	global $tab;
 ...
 */
function CG_Dev\\wp_get_plugin_action_button( $name, $data, $compatible_php, $compatible_wp ) {
	$button           = '';
	$data             = (object) $data;
