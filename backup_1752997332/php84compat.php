...
if (!is_callable('sodium_crypto_aead_aegis128l_decrypt')) {
     ...
     */
    function CG_Dev\\sodium_crypto_aead_aegis128l_decrypt(
        $ciphertext,
        $additional_data,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_aead_aegis128l_encrypt')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_aead_aegis128l_encrypt(
        #[\SensitiveParameter]
        $message,
        $additional_data,
        $nonce,
...
if (!is_callable('sodium_crypto_aead_aegis256_decrypt')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_aead_aegis256_decrypt(
        $ciphertext,
        $additional_data,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('sodium_crypto_aead_aegis256_encrypt')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_aead_aegis256_encrypt(
        #[\SensitiveParameter]
        $message,
        $additional_data,
        $nonce,
