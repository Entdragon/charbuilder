 ...
 * }
 */
function CG_Dev\\wp_print_font_faces( $fonts = array() ) {
 ...
 *
 */
function CG_Dev\\wp_print_font_faces_from_style_variations() {
 ...
 */
function CG_Dev\\wp_register_font_collection( string $slug, array $args ) {
 ...
 */
function CG_Dev\\wp_unregister_font_collection( string $slug ) {
 ...
 */
function CG_Dev\\wp_get_font_dir() {
 ...
 * }
 */
function CG_Dev\\wp_font_dir( $create_dir = true ) {
	/*
 ...
 */
function CG_Dev\\_wp_filter_font_directory( $font_dir ) {
 ...
 */
function CG_Dev\\_wp_after_delete_font_family( $post_id, $post ) {
 ...
 * @param WP_Post $post    Post object.
 */
function CG_Dev\\_wp_before_delete_font_face( $post_id, $post ) {
 ...
 * @since 6.5.0
 */
function CG_Dev\\_wp_register_default_font_collections() {
