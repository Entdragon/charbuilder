 ...
 */
function CG_Dev\\wp_nav_menu( $args = array() ) {
 ...
 */
function CG_Dev\\_wp_menu_item_classes_by_context( &$menu_items ) {
 ...
 */
function CG_Dev\\walk_nav_menu_tree( $items, $depth, $args ) {
 ...
 * @return string
 */
function CG_Dev\\_nav_menu_item_id_use_once( $id, $item ) {
 ...
 */
function CG_Dev\\wp_nav_menu_remove_menu_item_has_children_class( $classes, $menu_item, $args = false, $depth = false ) {
	/*
