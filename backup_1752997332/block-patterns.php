 ...
 * @access private
 */
function CG_Dev\\_register_core_block_patterns_and_categories() {
 ...
 */
function CG_Dev\\wp_normalize_remote_block_pattern( $pattern ) {
 ...
 */
function CG_Dev\\_load_remote_block_patterns( $deprecated = null ) {
	if ( ! empty( $deprecated ) ) {
 ...
 */
function CG_Dev\\_load_remote_featured_patterns() {
	$supports_core_patterns = get_theme_support( 'core-block-patterns' );
 ...
 * @access private
 */
function CG_Dev\\_register_remote_theme_patterns() {
	/** This filter is documented in wp-includes/block-patterns.php */
 ...
 * @access private
 */
function CG_Dev\\_register_theme_block_patterns() {
