 ...
 */
function CG_Dev\\get_network( $network = null ) {
	global $current_site;
 ...
 */
function CG_Dev\\get_networks( $args = array() ) {
 ...
 */
function CG_Dev\\clean_network_cache( $ids ) {
 ...
 */
function CG_Dev\\update_network_cache( $networks ) {
	$data = array();
 ...
 */
function CG_Dev\\_prime_network_caches( $network_ids ) {
	global $wpdb;
