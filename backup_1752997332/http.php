 ...
 */
function CG_Dev\\_wp_http_get_object() {
	static $http = null;
 ...
 */
function CG_Dev\\wp_safe_remote_request( $url, $args = array() ) {
 ...
 *                        See WP_Http::request() for information on return value.
 */
function CG_Dev\\wp_safe_remote_get( $url, $args = array() ) {
	$args['reject_unsafe_urls'] = true;
	$http                       = _wp_http_get_object();
 ...
 *                        See WP_Http::request() for information on return value.
 */
function CG_Dev\\wp_safe_remote_post( $url, $args = array() ) {
	$args['reject_unsafe_urls'] = true;
	$http                       = _wp_http_get_object();
 ...
 *                        See WP_Http::request() for information on return value.
 */
function CG_Dev\\wp_safe_remote_head( $url, $args = array() ) {
	$args['reject_unsafe_urls'] = true;
	$http                       = _wp_http_get_object();
 ...
 *                        See WP_Http::request() for information on return value.
 */
function CG_Dev\\wp_remote_request( $url, $args = array() ) {
	$http = _wp_http_get_object();
	return $http->request( $url, $args );
}
 ...
 *                        See WP_Http::request() for information on return value.
 */
function CG_Dev\\wp_remote_get( $url, $args = array() ) {
	$http = _wp_http_get_object();
	return $http->get( $url, $args );
}
 ...
 *                        See WP_Http::request() for information on return value.
 */
function CG_Dev\\wp_remote_post( $url, $args = array() ) {
	$http = _wp_http_get_object();
	return $http->post( $url, $args );
}
 ...
 *                        See WP_Http::request() for information on return value.
 */
function CG_Dev\\wp_remote_head( $url, $args = array() ) {
	$http = _wp_http_get_object();
	return $http->head( $url, $args );
}
 ...
 */
function CG_Dev\\wp_remote_retrieve_headers( $response ) {
 ...
 */
function CG_Dev\\wp_remote_retrieve_header( $response, $header ) {
	if ( is_wp_error( $response ) || ! isset( $response['headers'] ) ) {
		return '';
	}
 ...
 */
function CG_Dev\\wp_remote_retrieve_response_code( $response ) {
 ...
 */
function CG_Dev\\wp_remote_retrieve_response_message( $response ) {
	if ( is_wp_error( $response ) || ! isset( $response['response'] ) || ! is_array( $response['response'] ) ) {
		return '';
	}
 ...
 */
function CG_Dev\\wp_remote_retrieve_body( $response ) {
 ...
 */
function CG_Dev\\wp_remote_retrieve_cookies( $response ) {
 ...
 */
function CG_Dev\\wp_remote_retrieve_cookie( $response, $name ) {
 ...
 *                if the cookie is not present in the response.
 */
function CG_Dev\\wp_remote_retrieve_cookie_value( $response, $name ) {
 ...
 * @return bool
 */
function CG_Dev\\wp_http_supports( $capabilities = array(), $url = null ) {
 ...
 */
function CG_Dev\\get_http_origin() {
	$origin = '';
 ...
 */
function CG_Dev\\get_allowed_http_origins() {
 ...
 */
function CG_Dev\\is_allowed_http_origin( $origin = null ) {
	$origin_arg = $origin;
 ...
 */
function CG_Dev\\send_origin_headers() {
	$origin = get_http_origin();
 ...
 */
function CG_Dev\\wp_http_validate_url( $url ) {
 ...
 * @return bool
 */
function CG_Dev\\allowed_http_request_hosts( $is_external, $host ) {
 ...
 * @return bool
 */
function CG_Dev\\ms_allowed_http_request_hosts( $is_external, $host ) {
	global $wpdb;
 ...
 */
function CG_Dev\\wp_parse_url( $url, $component = -1 ) {
	$to_unset = array();
	$url      = (string) $url;
 ...
 *               PHP_URL_PORT - integer when it does. See parse_url()'s return values.
 */
function CG_Dev\\_get_component_from_parsed_url_array( $url_parts, $component = -1 ) {
	if ( -1 === $component ) {
		return $url_parts;
	}
 ...
 */
function CG_Dev\\_wp_translate_php_url_constant_to_key( $constant ) {
	$translation = array(
