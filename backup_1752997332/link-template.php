 ...
 */
function CG_Dev\\the_permalink( $post = 0 ) {
	/**
 ...
 */
function CG_Dev\\user_trailingslashit( $url, $type_of_url = '' ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\permalink_anchor( $mode = 'id' ) {
	$post = get_post();
 ...
 */
function CG_Dev\\wp_force_plain_post_permalink( $post = null, $sample = null ) {
	if (
		null === $sample &&
		is_object( $post ) &&
		isset( $post->filter ) &&
 ...
 */
function CG_Dev\\get_the_permalink( $post = 0, $leavename = false ) {
 ...
 * @return string|false The permalink URL. False if the post does not exist.
 */
function CG_Dev\\get_permalink( $post = 0, $leavename = false ) {
	$rewritecode = array(
		'%year%',
		'%monthnum%',
		'%day%',
 ...
 */
function CG_Dev\\get_post_permalink( $post = 0, $leavename = false, $sample = false ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_page_link( $post = false, $leavename = false, $sample = false ) {
	$post = get_post( $post );
 ...
 * @return string The page permalink.
 */
function CG_Dev\\_get_page_link( $post = false, $leavename = false, $sample = false ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_attachment_link( $post = null, $leavename = false ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_year_link( $year ) {
	global $wp_rewrite;
	if ( ! $year ) {
		$year = current_time( 'Y' );
	}
 ...
 */
function CG_Dev\\get_month_link( $year, $month ) {
	global $wp_rewrite;
	if ( ! $year ) {
		$year = current_time( 'Y' );
	}
 ...
 */
function CG_Dev\\get_day_link( $year, $month, $day ) {
	global $wp_rewrite;
	if ( ! $year ) {
		$year = current_time( 'Y' );
	}
 ...
 */
function CG_Dev\\the_feed_link( $anchor, $feed = '' ) {
 ...
 */
function CG_Dev\\get_feed_link( $feed = '' ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_post_comments_feed_link( $post_id = 0, $feed = '' ) {
 ...
 *                          Default is the value of get_default_feed().
 */
function CG_Dev\\post_comments_feed_link( $link_text = '', $post_id = '', $feed = '' ) {
 ...
 */
function CG_Dev\\get_author_feed_link( $author_id, $feed = '' ) {
 ...
 */
function CG_Dev\\get_category_feed_link( $cat, $feed = '' ) {
 ...
 */
function CG_Dev\\get_term_feed_link( $term, $taxonomy = '', $feed = '' ) {
	if ( ! is_object( $term ) ) {
		$term = (int) $term;
	}
 ...
 */
function CG_Dev\\get_tag_feed_link( $tag, $feed = '' ) {
 ...
 */
function CG_Dev\\get_edit_tag_link( $tag, $taxonomy = 'post_tag' ) {
	/**
 ...
 *                        Default null.
 */
function CG_Dev\\edit_tag_link( $link = '', $before = '', $after = '', $tag = null ) {
 ...
 */
function CG_Dev\\get_edit_term_link( $term, $taxonomy = '', $object_type = '' ) {
	$term = get_term( $term, $taxonomy );
 ...
 */
function CG_Dev\\edit_term_link( $link = '', $before = '', $after = '', $term = null, $display = true ) {
	if ( is_null( $term ) ) {
 ...
 */
function CG_Dev\\get_search_link( $query = '' ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_search_feed_link( $search_query = '', $feed = '' ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_search_comments_feed_link( $search_query = '', $feed = '' ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_post_type_archive_link( $post_type ) {
	global $wp_rewrite;
 ...
 *                      does not exist or does not have an archive.
 */
function CG_Dev\\get_post_type_archive_feed_link( $post_type, $feed = '' ) {
 ...
 */
function CG_Dev\\get_preview_post_link( $post = null, $query_args = array(), $preview_link = '' ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\get_edit_post_link( $post = 0, $context = 'display' ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\edit_post_link( $text = null, $before = '', $after = '', $post = 0, $css_class = 'post-edit-link' ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\get_delete_post_link( $post = 0, $deprecated = '', $force_delete = false ) {
	if ( ! empty( $deprecated ) ) {
 ...
 */
function CG_Dev\\get_edit_comment_link( $comment_id = 0, $context = 'display' ) {
 ...
 * @param string $after  Optional. Display after edit link. Default empty.
 */
function CG_Dev\\edit_comment_link( $text = null, $before = '', $after = '' ) {
	$comment = get_comment();
 ...
 */
function CG_Dev\\get_edit_bookmark_link( $link = 0 ) {
 ...
 */
function CG_Dev\\edit_bookmark_link( $link = '', $before = '', $after = '', $bookmark = null ) {
 ...
 */
function CG_Dev\\get_edit_user_link( $user_id = null ) {
	if ( ! $user_id ) {
 ...
 */
function CG_Dev\\get_previous_post( $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
 ...
 *                             Empty string if no corresponding post exists.
 */
function CG_Dev\\get_next_post( $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
 ...
 *                             Empty string if no corresponding post exists.
 */
function CG_Dev\\get_adjacent_post( $in_same_term = false, $excluded_terms = '', $previous = true, $taxonomy = 'category' ) {
	global $wpdb;
 ...
 */
function CG_Dev\\get_adjacent_post_rel_link( $title = '%title', $in_same_term = false, $excluded_terms = '', $previous = true, $taxonomy = 'category' ) {
	$post = get_post();
 ...
 * @param string       $taxonomy       Optional. Taxonomy, if `$in_same_term` is true. Default 'category'.
 */
function CG_Dev\\adjacent_posts_rel_link( $title = '%title', $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
 ...
 */
function CG_Dev\\adjacent_posts_rel_link_wp_head() {
 ...
 * @param string       $taxonomy       Optional. Taxonomy, if `$in_same_term` is true. Default 'category'.
 */
function CG_Dev\\next_post_rel_link( $title = '%title', $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
	echo get_adjacent_post_rel_link( $title, $in_same_term, $excluded_terms, false, $taxonomy );
}
 ...
 * @param string       $taxonomy       Optional. Taxonomy, if `$in_same_term` is true. Default 'category'.
 */
function CG_Dev\\prev_post_rel_link( $title = '%title', $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
	echo get_adjacent_post_rel_link( $title, $in_same_term, $excluded_terms, true, $taxonomy );
}
 ...
 */
function CG_Dev\\get_boundary_post( $in_same_term = false, $excluded_terms = '', $start = true, $taxonomy = 'category' ) {
	$post = get_post();
 ...
 */
function CG_Dev\\get_previous_post_link( $format = '&laquo; %link', $link = '%title', $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
 ...
 * @param string       $taxonomy       Optional. Taxonomy, if `$in_same_term` is true. Default 'category'.
 */
function CG_Dev\\previous_post_link( $format = '&laquo; %link', $link = '%title', $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
 ...
 */
function CG_Dev\\get_next_post_link( $format = '%link &raquo;', $link = '%title', $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
 ...
 * @param string       $taxonomy       Optional. Taxonomy, if `$in_same_term` is true. Default 'category'.
 */
function CG_Dev\\next_post_link( $format = '%link &raquo;', $link = '%title', $in_same_term = false, $excluded_terms = '', $taxonomy = 'category' ) {
 ...
 */
function CG_Dev\\get_adjacent_post_link( $format, $link, $in_same_term = false, $excluded_terms = '', $previous = true, $taxonomy = 'category' ) {
 ...
 * @param string       $taxonomy       Optional. Taxonomy, if `$in_same_term` is true. Default 'category'.
 */
function CG_Dev\\adjacent_post_link( $format, $link, $in_same_term = false, $excluded_terms = '', $previous = true, $taxonomy = 'category' ) {
 ...
 */
function CG_Dev\\get_pagenum_link( $pagenum = 1, $escape = true ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_next_posts_page_link( $max_page = 0 ) {
	global $paged;
 ...
 */
function CG_Dev\\next_posts( $max_page = 0, $display = true ) {
 ...
 */
function CG_Dev\\get_next_posts_link( $label = null, $max_page = 0 ) {
 ...
 * @param int    $max_page Optional. Max pages. Default 0.
 */
function CG_Dev\\next_posts_link( $label = null, $max_page = 0 ) {
 ...
 */
function CG_Dev\\get_previous_posts_page_link() {
	global $paged;
 ...
 */
function CG_Dev\\previous_posts( $display = true ) {
 ...
 */
function CG_Dev\\get_previous_posts_link( $label = null ) {
	global $paged;
 ...
 * @param string $label Optional. Previous page link text.
 */
function CG_Dev\\previous_posts_link( $label = null ) {
 ...
 */
function CG_Dev\\get_posts_nav_link( $args = array() ) {
	global $wp_query;
 ...
 */
function CG_Dev\\posts_nav_link( $sep = '', $prelabel = '', $nxtlabel = '' ) {
 ...
 */
function CG_Dev\\get_the_post_navigation( $args = array() ) {
 ...
 *                    Default empty array.
 */
function CG_Dev\\the_post_navigation( $args = array() ) {
 ...
 */
function CG_Dev\\get_the_posts_navigation( $args = array() ) {
	global $wp_query;
 ...
 *                    Default empty array.
 */
function CG_Dev\\the_posts_navigation( $args = array() ) {
 ...
 */
function CG_Dev\\get_the_posts_pagination( $args = array() ) {
	global $wp_query;
 ...
 *                    Default empty array.
 */
function CG_Dev\\the_posts_pagination( $args = array() ) {
 ...
 */
function CG_Dev\\_navigation_markup( $links, $css_class = 'posts-navigation', $screen_reader_text = '', $aria_label = '' ) {
 ...
 */
function CG_Dev\\get_comments_pagenum_link( $pagenum = 1, $max_page = 0 ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_next_comments_link( $label = '', $max_page = 0, $page = null ) {
	global $wp_query;
 ...
 * @param int    $max_page Optional. Max page. Default 0.
 */
function CG_Dev\\next_comments_link( $label = '', $max_page = 0 ) {
 ...
 */
function CG_Dev\\get_previous_comments_link( $label = '', $page = null ) {
	if ( ! is_singular() ) {
		return;
	}
 ...
 * @param string $label Optional. Label for comments link text. Default empty.
 */
function CG_Dev\\previous_comments_link( $label = '' ) {
 ...
 */
function CG_Dev\\paginate_comments_links( $args = array() ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\get_the_comments_navigation( $args = array() ) {
	$navigation = '';
 ...
 */
function CG_Dev\\the_comments_navigation( $args = array() ) {
 ...
 * @return string Markup for pagination links.
 */
function CG_Dev\\get_the_comments_pagination( $args = array() ) {
	$navigation = '';
 ...
 */
function CG_Dev\\the_comments_pagination( $args = array() ) {
 ...
 */
function CG_Dev\\home_url( $path = '', $scheme = null ) {
 ...
 * @return string Home URL link with optional path appended.
 */
function CG_Dev\\get_home_url( $blog_id = null, $path = '', $scheme = null ) {
	$orig_scheme = $scheme;
 ...
 */
function CG_Dev\\site_url( $path = '', $scheme = null ) {
 ...
 * @return string Site URL link with optional path appended.
 */
function CG_Dev\\get_site_url( $blog_id = null, $path = '', $scheme = null ) {
	if ( empty( $blog_id ) || ! is_multisite() ) {
 ...
 */
function CG_Dev\\admin_url( $path = '', $scheme = 'admin' ) {
 ...
 * @return string Admin URL link with optional path appended.
 */
function CG_Dev\\get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
 ...
 */
function CG_Dev\\includes_url( $path = '', $scheme = null ) {
 ...
 */
function CG_Dev\\content_url( $path = '' ) {
 ...
 */
function CG_Dev\\plugins_url( $path = '', $plugin = '' ) {
 ...
 * @return string Site URL link with optional path appended.
 */
function CG_Dev\\network_site_url( $path = '', $scheme = null ) {
	if ( ! is_multisite() ) {
 ...
 * @return string Home URL link with optional path appended.
 */
function CG_Dev\\network_home_url( $path = '', $scheme = null ) {
	if ( ! is_multisite() ) {
 ...
 * @return string Admin URL link with optional path appended.
 */
function CG_Dev\\network_admin_url( $path = '', $scheme = 'admin' ) {
	if ( ! is_multisite() ) {
 ...
 * @return string Admin URL link with optional path appended.
 */
function CG_Dev\\user_admin_url( $path = '', $scheme = 'admin' ) {
 ...
 * @return string Admin URL link with optional path appended.
 */
function CG_Dev\\self_admin_url( $path = '', $scheme = 'admin' ) {
	if ( is_network_admin() ) {
 ...
 */
function CG_Dev\\set_url_scheme( $url, $scheme = null ) {
	$orig_scheme = $scheme;
 ...
 */
function CG_Dev\\get_dashboard_url( $user_id = 0, $path = '', $scheme = 'admin' ) {
 ...
 * @return string Dashboard URL link with optional path appended.
 */
function CG_Dev\\get_edit_profile_url( $user_id = 0, $scheme = 'admin' ) {
	$user_id = $user_id ? (int) $user_id : get_current_user_id();
 ...
 */
function CG_Dev\\wp_get_canonical_url( $post = null ) {
	$post = get_post( $post );
 ...
 *                are not enabled.
 */
function CG_Dev\\wp_get_shortlink( $id = 0, $context = 'post', $allow_slugs = true ) {
	/**
 ...
 * @since 3.0.0
 */
function CG_Dev\\wp_shortlink_wp_head() {
 ...
 * @since 3.0.0
 */
function CG_Dev\\wp_shortlink_header() {
	if ( headers_sent() ) {
		return;
	}
 ...
 */
function CG_Dev\\the_shortlink( $text = '', $title = '', $before = '', $after = '' ) {
	$post = get_post();
 ...
 */
function CG_Dev\\get_avatar_url( $id_or_email, $args = null ) {
 ...
 */
function CG_Dev\\is_avatar_comment_type( $comment_type ) {
	/**
 ...
 * }
 */
function CG_Dev\\get_avatar_data( $id_or_email, $args = null ) {
	$args = wp_parse_args(
		$args,
		array(
			'size'           => 96,
 ...
 */
function CG_Dev\\get_theme_file_uri( $file = '' ) {
	$file = ltrim( $file, '/' );
 ...
 * @return string The URL of the file.
 */
function CG_Dev\\get_parent_theme_file_uri( $file = '' ) {
	$file = ltrim( $file, '/' );
 ...
 */
function CG_Dev\\get_theme_file_path( $file = '' ) {
	$file = ltrim( $file, '/' );
 ...
 * @return string The path of the file.
 */
function CG_Dev\\get_parent_theme_file_path( $file = '' ) {
	$file = ltrim( $file, '/' );
 ...
 */
function CG_Dev\\get_privacy_policy_url() {
	$url            = '';
 ...
 */
function CG_Dev\\the_privacy_policy_link( $before = '', $after = '' ) {
 ...
 *                doesn't exist.
 */
function CG_Dev\\get_the_privacy_policy_link( $before = '', $after = '' ) {
	$link               = '';
 ...
 */
function CG_Dev\\wp_internal_hosts() {
 ...
 */
function CG_Dev\\wp_is_internal_link( $link ) {
