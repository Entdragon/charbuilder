...
if (!is_callable('sodium_crypto_core_ristretto255_add')) {
     ...
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_add(
        #[\SensitiveParameter]
        $p,
        #[\SensitiveParameter]
        $q
...
if (!is_callable('sodium_crypto_core_ristretto255_from_hash')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_from_hash(
        #[\SensitiveParameter]
        $s
    ) {
...
if (!is_callable('sodium_crypto_core_ristretto255_is_valid_point')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_is_valid_point(
        #[\SensitiveParameter]
        $s
    ) {
...
if (!is_callable('sodium_crypto_core_ristretto255_random')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_random()
    {
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_add')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_add(
        #[\SensitiveParameter]
        $x,
        #[\SensitiveParameter]
        $y
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_complement')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_complement(
        #[\SensitiveParameter]
        $s
    ) {
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_invert')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_invert(
        #[\SensitiveParameter]
        $p
    ) {
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_mul')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_mul(
        #[\SensitiveParameter]
        $x,
        #[\SensitiveParameter]
        $y
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_negate')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_negate(
        #[\SensitiveParameter]
        $s
    ) {
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_random')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_random()
    {
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_reduce')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_reduce(
        #[\SensitiveParameter]
        $s
    ) {
...
if (!is_callable('sodium_crypto_core_ristretto255_scalar_sub')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_scalar_sub(
        #[\SensitiveParameter]
        $x,
        #[\SensitiveParameter]
        $y
...
if (!is_callable('sodium_crypto_core_ristretto255_sub')) {
     ...
     * @throws SodiumException
     */
    function CG_Dev\\sodium_crypto_core_ristretto255_sub(
        #[\SensitiveParameter]
        $p,
        #[\SensitiveParameter]
        $q
...
if (!is_callable('sodium_crypto_scalarmult_ristretto255')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_scalarmult_ristretto255(
        #[\SensitiveParameter]
        $n,
        #[\SensitiveParameter]
        $p
...
if (!is_callable('sodium_crypto_scalarmult_ristretto255_base')) {
     ...
     * @throws TypeError
     */
    function CG_Dev\\sodium_crypto_scalarmult_ristretto255_base(
        #[\SensitiveParameter]
        $n
    ) {
