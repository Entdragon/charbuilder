 ...
 */
function CG_Dev\\delete_theme( $stylesheet, $redirect = '' ) {
 ...
 */
function CG_Dev\\get_page_templates( $post = null, $post_type = 'page' ) {
 ...
 * @return string
 */
function CG_Dev\\_get_template_edit_filename( $fullpath, $containingfolder ) {
 ...
 */
function CG_Dev\\theme_update_available( $theme ) {
 ...
 */
function CG_Dev\\get_theme_update_available( $theme ) {
 ...
 */
function CG_Dev\\get_theme_feature_list( $api = true ) {
 ...
 */
function CG_Dev\\themes_api( $action, $args = array() ) {
	if ( is_array( $args ) ) {
		$args = (object) $args;
	}
 ...
 */
function CG_Dev\\wp_prepare_themes_for_js( $themes = null ) {
 ...
 * @since 4.2.0
 */
function CG_Dev\\customize_themes_print_templates() {
	?>
 ...
 */
function CG_Dev\\is_theme_paused( $theme ) {
 ...
 */
function CG_Dev\\wp_get_theme_error( $theme ) {
	if ( ! isset( $GLOBALS['_paused_themes'] ) ) {
		return false;
	}
 ...
 *                       `WP_Error` on failure.
 */
function CG_Dev\\resume_theme( $theme, $redirect = '' ) {
 ...
 * @global WP_Paused_Extensions_Storage $_paused_themes
 */
function CG_Dev\\paused_themes_notice() {
