 ...
 */
function CG_Dev\\get_the_author( $deprecated = '' ) {
	global $authordata;
 ...
 */
function CG_Dev\\the_author( $deprecated = '', $deprecated_echo = true ) {
	if ( ! empty( $deprecated ) ) {
		_deprecated_argument( __FUNCTION__, '2.1.0' );
	}
 ...
 */
function CG_Dev\\get_the_modified_author() {
 ...
 * @see get_the_author()
 */
function CG_Dev\\the_modified_author() {
 ...
 */
function CG_Dev\\get_the_author_meta( $field = '', $user_id = false ) {
 ...
 */
function CG_Dev\\the_author_meta( $field = '', $user_id = false ) {
 ...
 */
function CG_Dev\\get_the_author_link() {
 ...
 * @since 2.1.0
 */
function CG_Dev\\the_author_link() {
 ...
 */
function CG_Dev\\get_the_author_posts() {
	$post = get_post();
	if ( ! $post ) {
		return 0;
	}
 ...
 * @since 0.71
 */
function CG_Dev\\the_author_posts() {
 ...
 */
function CG_Dev\\get_the_author_posts_link() {
	global $authordata;
 ...
 */
function CG_Dev\\the_author_posts_link( $deprecated = '' ) {
	if ( ! empty( $deprecated ) ) {
		_deprecated_argument( __FUNCTION__, '2.1.0' );
	}
 ...
 */
function CG_Dev\\get_author_posts_url( $author_id, $author_nicename = '' ) {
	global $wp_rewrite;
 ...
 */
function CG_Dev\\wp_list_authors( $args = '' ) {
	global $wpdb;
 ...
 */
function CG_Dev\\is_multi_author() {
	global $wpdb;
 ...
 * @access private
 */
function CG_Dev\\__clear_multi_author_cache() { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
