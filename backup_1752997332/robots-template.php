 ...
 */
function CG_Dev\\wp_robots_noindex( array $robots ) {
 ...
 * @return array Filtered robots directives.
 */
function CG_Dev\\wp_robots_noindex_embeds( array $robots ) {
	if ( is_embed() ) {
		return wp_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function CG_Dev\\wp_robots_noindex_search( array $robots ) {
	if ( is_search() ) {
		return wp_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function CG_Dev\\wp_robots_no_robots( array $robots ) {
	$robots['noindex'] = true;
 ...
 * @return array Filtered robots directives.
 */
function CG_Dev\\wp_robots_sensitive_page( array $robots ) {
	$robots['noindex']   = true;
 ...
 * @return array Filtered robots directives.
 */
function CG_Dev\\wp_robots_max_image_preview_large( array $robots ) {
	if ( get_option( 'blog_public' ) ) {
