 ...
 */
function CG_Dev\\register_block_bindings_source( string $source_name, array $source_properties ) {
 ...
 */
function CG_Dev\\unregister_block_bindings_source( string $source_name ) {
 ...
 */
function CG_Dev\\get_all_registered_block_bindings_sources() {
 ...
 */
function CG_Dev\\get_block_bindings_source( string $source_name ) {
