 ...
 */
function CG_Dev\\get_column_headers( $screen ) {
 ...
 */
function CG_Dev\\get_hidden_columns( $screen ) {
	if ( is_string( $screen ) ) {
		$screen = convert_to_screen( $screen );
	}
 ...
 */
function CG_Dev\\meta_box_prefs( $screen ) {
 ...
 */
function CG_Dev\\get_hidden_meta_boxes( $screen ) {
	if ( is_string( $screen ) ) {
		$screen = convert_to_screen( $screen );
	}
 ...
 */
function CG_Dev\\add_screen_option( $option, $args = array() ) {
 ...
 */
function CG_Dev\\get_current_screen() {
 ...
 */
function CG_Dev\\set_current_screen( $hook_name = '' ) {
