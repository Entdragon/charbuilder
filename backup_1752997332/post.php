 ...
 */
function CG_Dev\\_wp_translate_postdata( $update = false, $post_data = null ) {
 ...
 * @return array|WP_Error Array of post data on success, WP_Error on failure.
 */
function CG_Dev\\_wp_get_allowed_postdata( $post_data = null ) {
	if ( empty( $post_data ) ) {
		$post_data = $_POST;
	}
 ...
 * @return int Post ID.
 */
function CG_Dev\\edit_post( $post_data = null ) {
	global $wpdb;
 ...
 * }
 */
function CG_Dev\\bulk_edit_posts( $post_data = null ) {
	global $wpdb;
 ...
 */
function CG_Dev\\get_default_post_to_edit( $post_type = 'post', $create_in_db = false ) {
	$post_title = '';
 ...
 */
function CG_Dev\\post_exists( $title, $content = '', $date = '', $type = '', $status = '' ) {
	global $wpdb;
 ...
 * @return int|bool
 */
function CG_Dev\\add_meta( $post_id ) {
	$post_id = (int) $post_id;
 ...
 * @return bool
 */
function CG_Dev\\delete_meta( $mid ) {
 ...
 * @return object|bool
 */
function CG_Dev\\get_post_meta_by_id( $mid ) {
 ...
 * }
 */
function CG_Dev\\has_meta( $post_id ) {
	global $wpdb;
 ...
 * @return bool
 */
function CG_Dev\\update_meta( $meta_id, $meta_key, $meta_value ) {
 ...
 */
function CG_Dev\\_fix_attachment_links( $post ) {
 ...
 */
function CG_Dev\\get_available_post_statuses( $type = 'post' ) {
 ...
 */
function CG_Dev\\wp_edit_posts_query( $q = false ) {
	if ( false === $q ) {
		$q = $_GET;
	}
 ...
 */
function CG_Dev\\wp_edit_attachments_query_vars( $q = false ) {
	if ( false === $q ) {
		$q = $_GET;
	}
	$q['m']         = isset( $q['m'] ) ? (int) $q['m'] : 0;
 ...
 * }
 */
function CG_Dev\\wp_edit_attachments_query( $q = false ) {
 ...
 */
function CG_Dev\\postbox_classes( $box_id, $screen_id ) {
 ...
 * }
 */
function CG_Dev\\get_sample_permalink( $post, $title = null, $name = null ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\get_sample_permalink_html( $post, $new_title = null, $new_slug = null ) {
	$post = get_post( $post );
 ...
 */
function CG_Dev\\_wp_post_thumbnail_html( $thumbnail_id = null, $post = null ) {
 ...
 */
function CG_Dev\\wp_check_post_lock( $post ) {
	$post = get_post( $post );
 ...
 * }
 */
function CG_Dev\\wp_set_post_lock( $post ) {
	$post = get_post( $post );
 ...
 * @since 2.8.5
 */
function CG_Dev\\_admin_notice_post_locked() {
	$post = get_post();
 ...
 */
function CG_Dev\\wp_create_post_autosave( $post_data ) {
 ...
 */
function CG_Dev\\wp_autosave_post_revisioned_meta_fields( $new_autosave ) {
	/*
 ...
 */
function CG_Dev\\wp_autosave( $post_data ) {
	// Back-compat.
 ...
 */
function CG_Dev\\redirect_post( $post_id = '' ) {
 ...
 */
function CG_Dev\\taxonomy_meta_box_sanitize_cb_checkboxes( $taxonomy, $terms ) {
 ...
 * @return array
 */
function CG_Dev\\taxonomy_meta_box_sanitize_cb_input( $taxonomy, $terms ) {
	/*
 ...
 */
function CG_Dev\\get_block_editor_server_block_settings() {
 ...
 */
function CG_Dev\\the_block_editor_meta_boxes() {
 ...
 */
function CG_Dev\\the_block_editor_meta_box_post_form_hidden_fields( $post ) {
	$form_extra = '';
	if ( 'auto-draft' === $post->post_status ) {
 ...
 */
function CG_Dev\\_disable_block_editor_for_navigation_post_type( $value, $post_type ) {
 ...
 */
function CG_Dev\\_disable_content_editor_for_navigation_post_type( $post ) {
 ...
 * @param WP_Post $post An instance of WP_Post class.
 */
function CG_Dev\\_enable_content_editor_for_navigation_post_type( $post ) {
	$post_type = get_post_type( $post );
	if ( 'wp_navigation' !== $post_type ) {
		return;
	}
