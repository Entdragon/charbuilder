 ...
 */
function CG_Dev\\is_subdomain_install() {
 ...
 */
function CG_Dev\\wp_get_active_network_plugins() {
 ...
 */
function CG_Dev\\get_network_by_path( $domain, $path, $segments = null ) {
 ...
 */
function CG_Dev\\get_site_by_path( $domain, $path, $segments = null ) {
 ...
 */
function CG_Dev\\ms_load_current_site_and_network( $domain, $path, $subdomain = false ) {
 ...
 */
function CG_Dev\\ms_not_installed( $domain, $path ) {
	global $wpdb;
 ...
 * @return WP_Network
 */
function CG_Dev\\get_current_site_name( $current_site ) {
 ...
 * @return WP_Network
 */
function CG_Dev\\wpmu_current_site() {
	global $current_site;
 ...
 */
function CG_Dev\\wp_get_network( $network ) {
