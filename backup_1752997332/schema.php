 ...
 */
function CG_Dev\\wp_get_db_schema( $scope = 'all', $blog_id = null ) {
	global $wpdb;
 ...
 */
function CG_Dev\\populate_options( array $options = array() ) {
 ...
 * @since 2.0.0
 */
function CG_Dev\\populate_roles() {
	populate_roles_160();
	populate_roles_210();
	populate_roles_230();
	populate_roles_250();
 ...
 * @since 2.0.0
 */
function CG_Dev\\populate_roles_160() {
	// Add roles.
 ...
 * @since 2.1.0
 */
function CG_Dev\\populate_roles_210() {
 ...
 * @since 2.3.0
 */
function CG_Dev\\populate_roles_230() {
	$role = get_role( 'administrator' );
 ...
 * @since 2.5.0
 */
function CG_Dev\\populate_roles_250() {
	$role = get_role( 'administrator' );
 ...
 * @since 2.6.0
 */
function CG_Dev\\populate_roles_260() {
	$role = get_role( 'administrator' );
 ...
 * @since 2.7.0
 */
function CG_Dev\\populate_roles_270() {
	$role = get_role( 'administrator' );
 ...
 * @since 2.8.0
 */
function CG_Dev\\populate_roles_280() {
	$role = get_role( 'administrator' );
 ...
 * @since 3.0.0
 */
function CG_Dev\\populate_roles_300() {
	$role = get_role( 'administrator' );
...
if ( ! function_exists( 'install_network' ) ) :
	 ...
	 * @since 3.0.0
	 */
	function CG_Dev\\install_network() {
 ...
 */
function CG_Dev\\populate_network( $network_id = 1, $domain = '', $email = '', $site_name = '', $path = '/', $subdomain_install = false ) {
 ...
 */
function CG_Dev\\populate_network_meta( $network_id, array $meta = array() ) {
 ...
 * @param array $meta    Optional. Custom meta $key => $value pairs to use. Default empty array.
 */
function CG_Dev\\populate_site_meta( $site_id, array $meta = array() ) {
	global $wpdb;
