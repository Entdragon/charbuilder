 ...
 * @return int|WP_Error Value 0 or WP_Error on failure. The link ID on success.
 */
function CG_Dev\\edit_link( $link_id = 0 ) {
 ...
 */
function CG_Dev\\get_default_link_to_edit() {
	$link = new stdClass();
 ...
 */
function CG_Dev\\wp_delete_link( $link_id ) {
	global $wpdb;
	/**
 ...
 */
function CG_Dev\\wp_get_link_cats( $link_id = 0 ) {
 ...
 */
function CG_Dev\\get_link_to_edit( $link ) {
 ...
 * @return int|WP_Error Value 0 or WP_Error on failure. The link ID on success.
 */
function CG_Dev\\wp_insert_link( $linkdata, $wp_error = false ) {
	global $wpdb;
 ...
 */
function CG_Dev\\wp_set_link_cats( $link_id = 0, $link_categories = array() ) {
 ...
 */
function CG_Dev\\wp_update_link( $linkdata ) {
 ...
 */
function CG_Dev\\wp_link_manager_disabled_message() {
	global $pagenow;
