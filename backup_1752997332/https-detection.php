 ...
 */
function CG_Dev\\wp_is_using_https() {
 ...
 * @return bool True if using HTTPS, false otherwise.
 */
function CG_Dev\\wp_is_home_url_using_https() {
 ...
 * @return bool True if using HTTPS, false otherwise.
 */
function CG_Dev\\wp_is_site_url_using_https() {
	/*
 ...
 */
function CG_Dev\\wp_is_https_supported() {
 ...
 */
function CG_Dev\\wp_get_https_detection_errors() {
	/**
 ...
 */
function CG_Dev\\wp_is_local_html_output( $html ) {
