 ...
 */
function CG_Dev\\wp_get_theme_preview_path( $current_stylesheet = null ) {
 ...
 * @since 6.3.0
 */
function CG_Dev\\wp_attach_theme_preview_middleware() {
 ...
 * @access private
 */
function CG_Dev\\wp_block_theme_activate_nonce() {
 ...
 * @since 6.3.2
 */
function CG_Dev\\wp_initialize_theme_preview_hooks() {
