 ...
 */
function CG_Dev\\wptexturize( $text, $reset = false ) {
 ...
 */
function CG_Dev\\wptexturize_primes( $haystack, $needle, $prime, $open_quote, $close_quote ) {
	$spaces           = wp_spaces_regexp();
 ...
 */
function CG_Dev\\_wptexturize_pushpop_element( $text, &$stack, $disabled_elements ) {
 ...
 */
function CG_Dev\\wpautop( $text, $br = true ) {
	$pre_tags = array();
 ...
 */
function CG_Dev\\wp_html_split( $input ) {
 ...
 */
function CG_Dev\\get_html_split_regex() {
	static $regex;
 ...
 * @return string The regular expression.
 */
function CG_Dev\\_get_wptexturize_split_regex( $shortcode_regex = '' ) {
	static $html_regex;
 ...
 * @return string The regular expression.
 */
function CG_Dev\\_get_wptexturize_shortcode_regex( $tagnames ) {
 ...
 */
function CG_Dev\\wp_replace_in_html_tags( $haystack, $replace_pairs ) {
	// Find all elements.
 ...
 * @return string
 */
function CG_Dev\\_autop_newline_preservation_helper( $matches ) {
 ...
 */
function CG_Dev\\shortcode_unautop( $text ) {
 ...
 */
function CG_Dev\\seems_utf8( $str ) {
 ...
 */
function CG_Dev\\_wp_specialchars( $text, $quote_style = ENT_NOQUOTES, $charset = false, $double_encode = false ) {
	$text = (string) $text;
 ...
 */
function CG_Dev\\wp_specialchars_decode( $text, $quote_style = ENT_NOQUOTES ) {
	$text = (string) $text;
 ...
 */
function CG_Dev\\wp_check_invalid_utf8( $text, $strip = false ) {
	$text = (string) $text;
 ...
 */
function CG_Dev\\utf8_uri_encode( $utf8_string, $length = 0, $encode_ascii_characters = false ) {
	$unicode        = '';
	$values         = array();
	$num_octets     = 1;
	$unicode_length = 0;
 ...
 */
function CG_Dev\\remove_accents( $text, $locale = '' ) {
 ...
 */
function CG_Dev\\sanitize_file_name( $filename ) {
 ...
 */
function CG_Dev\\sanitize_user( $username, $strict = false ) {
 ...
 */
function CG_Dev\\sanitize_key( $key ) {
	$sanitized_key = '';
 ...
 */
function CG_Dev\\sanitize_title( $title, $fallback_title = '', $context = 'save' ) {
	$raw_title = $title;
 ...
 * @return string The sanitized string.
 */
function CG_Dev\\sanitize_title_for_query( $title ) {
 ...
 */
function CG_Dev\\sanitize_title_with_dashes( $title, $raw_title = '', $context = 'display' ) {
 ...
 */
function CG_Dev\\sanitize_sql_orderby( $orderby ) {
 ...
 */
function CG_Dev\\sanitize_html_class( $classname, $fallback = '' ) {
 ...
 * @return string The sanitized value.
 */
function CG_Dev\\sanitize_locale_name( $locale_name ) {
	// Limit to A-Z, a-z, 0-9, '_', '-'.
 ...
 */
function CG_Dev\\convert_chars( $content, $deprecated = '' ) {
	if ( ! empty( $deprecated ) ) {
 ...
 * @return string Converted string.
 */
function CG_Dev\\convert_invalid_entities( $content ) {
 ...
 */
function CG_Dev\\balanceTags( $text, $force = false ) {  // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 * @return string Balanced text.
 */
function CG_Dev\\force_balance_tags( $text ) {
	$tagstack  = array();
	$stacksize = 0;
	$tagqueue  = '';
	$newtext   = '';
 ...
 */
function CG_Dev\\format_to_edit( $content, $rich_text = false ) {
	/**
 ...
 */
function CG_Dev\\zeroise( $number, $threshold ) {
 ...
 */
function CG_Dev\\backslashit( $value ) {
 ...
 */
function CG_Dev\\trailingslashit( $value ) {
 ...
 */
function CG_Dev\\untrailingslashit( $value ) {
	return rtrim( $value, '/\\' );
}
 ...
 */
function CG_Dev\\addslashes_gpc( $gpc ) {
	return wp_slash( $gpc );
}
 ...
 */
function CG_Dev\\stripslashes_deep( $value ) {
 ...
 */
function CG_Dev\\stripslashes_from_strings_only( $value ) {
 ...
 */
function CG_Dev\\urlencode_deep( $value ) {
 ...
 * @return mixed The encoded value.
 */
function CG_Dev\\rawurlencode_deep( $value ) {
 ...
 */
function CG_Dev\\urldecode_deep( $value ) {
 ...
 */
function CG_Dev\\antispambot( $email_address, $hex_encoding = 0 ) {
 ...
 */
function CG_Dev\\_make_url_clickable_cb( $matches ) {
	$url = $matches[2];
 ...
 */
function CG_Dev\\_make_web_ftp_clickable_cb( $matches ) {
	$ret  = '';
	$dest = $matches[2];
	$dest = 'http://' . $dest;
 ...
 */
function CG_Dev\\_make_email_clickable_cb( $matches ) {
 ...
 */
function CG_Dev\\_make_clickable_rel_attr( $url ) {
	$rel_parts        = array();
 ...
 */
function CG_Dev\\make_clickable( $text ) {
	$r               = '';
 ...
 */
function CG_Dev\\_split_str_by_whitespace( $text, $goal ) {
	$chunks = array();
 ...
 */
function CG_Dev\\wp_rel_callback( $matches, $rel ) {
	$text = $matches[1];
 ...
 */
function CG_Dev\\wp_rel_nofollow( $text ) {
 ...
 */
function CG_Dev\\wp_rel_nofollow_callback( $matches ) {
	return wp_rel_callback( $matches, 'nofollow' );
}
 ...
 * @return string Converted content.
 */
function CG_Dev\\wp_rel_ugc( $text ) {
	// This is a pre-save filter, so text is already escaped.
	$text = stripslashes( $text );
	$text = preg_replace_callback(
		'|<a (.+?)>|i',
 ...
 * @return string Converted content.
 */
function CG_Dev\\wp_targeted_link_rel( $text ) {
 ...
 */
function CG_Dev\\wp_targeted_link_rel_callback( $matches ) {
	_deprecated_function( __FUNCTION__, '6.7.0' );
 ...
 * @deprecated 6.7.0
 */
function CG_Dev\\wp_init_targeted_link_rel_filters() {
	_deprecated_function( __FUNCTION__, '6.7.0' );
}
 ...
 * @deprecated 6.7.0
 */
function CG_Dev\\wp_remove_targeted_link_rel_filters() {
	_deprecated_function( __FUNCTION__, '6.7.0' );
}
 ...
 */
function CG_Dev\\translate_smiley( $matches ) {
 ...
 */
function CG_Dev\\convert_smilies( $text ) {
 ...
 */
function CG_Dev\\is_email( $email, $deprecated = false ) {
	if ( ! empty( $deprecated ) ) {
 ...
 */
function CG_Dev\\wp_iso_descrambler( $subject ) {
 ...
 */
function CG_Dev\\_wp_iso_convert( $matches ) {
 ...
 */
function CG_Dev\\get_gmt_from_date( $date_string, $format = 'Y-m-d H:i:s' ) {
 ...
 */
function CG_Dev\\get_date_from_gmt( $date_string, $format = 'Y-m-d H:i:s' ) {
 ...
 */
function CG_Dev\\iso8601_timezone_to_offset( $timezone ) {
 ...
 */
function CG_Dev\\iso8601_to_datetime( $date_string, $timezone = 'user' ) {
 ...
 */
function CG_Dev\\sanitize_email( $email ) {
	// Test for the minimum length the email can be.
	if ( strlen( $email ) < 6 ) {
		/**
 ...
 */
function CG_Dev\\human_time_diff( $from, $to = 0 ) {
	if ( empty( $to ) ) {
		$to = time();
	}
 ...
 */
function CG_Dev\\wp_trim_excerpt( $text = '', $post = null ) {
	$raw_excerpt = $text;
 ...
 */
function CG_Dev\\wp_trim_words( $text, $num_words = 55, $more = null ) {
	if ( null === $more ) {
		$more = __( '&hellip;' );
	}
 ...
 */
function CG_Dev\\format_for_editor( $text, $default_editor = null ) {
	if ( $text ) {
 ...
 */
function CG_Dev\\_deep_replace( $search, $subject ) {
 ...
 */
function CG_Dev\\esc_url( $url, $protocols = null, $_context = 'display' ) {
	$original_url = $url;
 ...
 */
function CG_Dev\\esc_url_raw( $url, $protocols = null ) {
 ...
 */
function CG_Dev\\sanitize_url( $url, $protocols = null ) {
 ...
 */
function CG_Dev\\htmlentities2( $text ) {
 ...
 * @return string
 */
function CG_Dev\\esc_textarea( $text ) {
 ...
 * @return string
 */
function CG_Dev\\tag_escape( $tag_name ) {
 ...
 */
function CG_Dev\\wp_make_link_relative( $link ) {
 ...
 */
function CG_Dev\\sanitize_option( $option, $value ) {
	global $wpdb;
 ...
 */
function CG_Dev\\map_deep( $value, $callback ) {
	if ( is_array( $value ) ) {
 ...
 */
function CG_Dev\\wp_parse_str( $input_string, &$result ) {
 ...
 * @return string Converted text.
 */
function CG_Dev\\wp_pre_kses_less_than( $content ) {
 ...
 */
function CG_Dev\\wp_pre_kses_less_than_callback( $matches ) {
 ...
 */
function CG_Dev\\wp_pre_kses_block_attributes( $content, $allowed_html, $allowed_protocols ) {
	/*
 ...
 */
function CG_Dev\\wp_sprintf( $pattern, ...$args ) {
	$len       = strlen( $pattern );
	$start     = 0;
	$result    = '';
	$arg_index = 0;
 ...
 */
function CG_Dev\\wp_sprintf_l( $pattern, $args ) {
	// Not a match.
 ...
 * @return string The excerpt.
 */
function CG_Dev\\wp_html_excerpt( $str, $count, $more = null ) {
	if ( null === $more ) {
		$more = '';
	}
 ...
 */
function CG_Dev\\links_add_base_url( $content, $base, $attrs = array( 'src', 'href' ) ) {
 ...
 */
function CG_Dev\\_links_add_base( $m ) {
	global $_links_add_base;
 ...
 * @return string The processed content.
 */
function CG_Dev\\links_add_target( $content, $target = '_blank', $tags = array( 'a' ) ) {
 ...
 * @return string The processed link.
 */
function CG_Dev\\_links_add_target( $m ) {
	global $_links_add_target;
	$tag  = $m[1];
 ...
 */
function CG_Dev\\wp_strip_all_tags( $text, $remove_breaks = false ) {
	if ( is_null( $text ) ) {
		return '';
	}
 ...
 */
function CG_Dev\\sanitize_text_field( $str ) {
 ...
 * @return string Sanitized string.
 */
function CG_Dev\\sanitize_textarea_field( $str ) {
 ...
 * @return string Sanitized string.
 */
function CG_Dev\\_sanitize_text_fields( $str, $keep_newlines = false ) {
 ...
 * @return string
 */
function CG_Dev\\wp_basename( $path, $suffix = '' ) {
 ...
 */
function CG_Dev\\capital_P_dangit( $text ) {
 ...
 */
function CG_Dev\\sanitize_mime_type( $mime_type ) {
 ...
 */
function CG_Dev\\sanitize_trackback_urls( $to_ping ) {
 ...
 */
function CG_Dev\\wp_slash( $value ) {
	if ( is_array( $value ) ) {
 ...
 */
function CG_Dev\\wp_unslash( $value ) {
 ...
 */
function CG_Dev\\get_url_in_content( $content ) {
	if ( empty( $content ) ) {
		return false;
	}
 ...
 */
function CG_Dev\\wp_spaces_regexp() {
	static $spaces = '';
 ...
 * @since 6.4.0
 */
function CG_Dev\\wp_enqueue_emoji_styles() {
 ...
 * @since 4.2.0
 */
function CG_Dev\\print_emoji_detection_script() {
 ...
 * @access private
 */
function CG_Dev\\_print_emoji_detection_script() {
	$settings = array(
		/**
 ...
 */
function CG_Dev\\wp_encode_emoji( $content ) {
 ...
 * @return string The encoded content.
 */
function CG_Dev\\wp_staticize_emoji( $text ) {
 ...
 */
function CG_Dev\\wp_staticize_emoji_for_email( $mail ) {
 ...
 */
function CG_Dev\\_wp_emoji_list( $type = 'entities' ) {
 ...
 */
function CG_Dev\\url_shorten( $url, $length = 35 ) {
 ...
 * @return string|void
 */
function CG_Dev\\sanitize_hex_color( $color ) {
	if ( '' === $color ) {
		return '';
	}
 ...
 * @return string|null
 */
function CG_Dev\\sanitize_hex_color_no_hash( $color ) {
	$color = ltrim( $color, '#' );
 ...
 * @return string
 */
function CG_Dev\\maybe_hash_hex_color( $color ) {
