 ...
 * }
 */
function CG_Dev\\get_plugin_data( $plugin_file, $markup = true, $translate = true ) {
 ...
 */
function CG_Dev\\_get_plugin_data_markup_translate( $plugin_file, $plugin_data, $markup = true, $translate = true ) {
 ...
 */
function CG_Dev\\get_plugin_files( $plugin ) {
 ...
 */
function CG_Dev\\get_plugins( $plugin_folder = '' ) {
 ...
 */
function CG_Dev\\get_mu_plugins() {
	$wp_plugins   = array();
	$plugin_files = array();
 ...
 */
function CG_Dev\\_sort_uname_callback( $a, $b ) {
 ...
 */
function CG_Dev\\is_plugin_active( $plugin ) {
 ...
 */
function CG_Dev\\is_plugin_inactive( $plugin ) {
 ...
 */
function CG_Dev\\is_plugin_active_for_network( $plugin ) {
	if ( ! is_multisite() ) {
		return false;
	}
 ...
 */
function CG_Dev\\is_network_only_plugin( $plugin ) {
 ...
 */
function CG_Dev\\activate_plugin( $plugin, $redirect = '', $network_wide = false, $silent = false ) {
 ...
 */
function CG_Dev\\deactivate_plugins( $plugins, $silent = false, $network_wide = null ) {
	if ( is_multisite() ) {
 ...
 */
function CG_Dev\\activate_plugins( $plugins, $redirect = '', $network_wide = false, $silent = false ) {
	if ( ! is_array( $plugins ) ) {
 ...
 */
function CG_Dev\\delete_plugins( $plugins, $deprecated = '' ) {
 ...
 */
function CG_Dev\\validate_active_plugins() {
 ...
 */
function CG_Dev\\validate_plugin( $plugin ) {
 ...
 */
function CG_Dev\\validate_plugin_requirements( $plugin ) {
 ...
 */
function CG_Dev\\is_uninstallable_plugin( $plugin ) {
 ...
 *                   Void otherwise.
 */
function CG_Dev\\uninstall_plugin( $plugin ) {
	$file = plugin_basename( $plugin );
 ...
 */
function CG_Dev\\add_menu_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $icon_url = '', $position = null ) {
 ...
 */
function CG_Dev\\add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_management_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_options_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_theme_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_plugins_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_users_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_dashboard_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_posts_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_media_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_links_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_pages_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 * @return string|false The resulting page's hook_suffix, or false if the user does not have the capability required.
 */
function CG_Dev\\add_comments_page( $page_title, $menu_title, $capability, $menu_slug, $callback = '', $position = null ) {
 ...
 */
function CG_Dev\\remove_menu_page( $menu_slug ) {
	global $menu;
 ...
 */
function CG_Dev\\remove_submenu_page( $menu_slug, $submenu_slug ) {
	global $submenu;
 ...
 */
function CG_Dev\\menu_page_url( $menu_slug, $display = true ) {
 ...
 */
function CG_Dev\\get_admin_page_parent( $parent_page = '' ) {
 ...
 */
function CG_Dev\\get_admin_page_title() {
 ...
 */
function CG_Dev\\get_plugin_page_hook( $plugin_page, $parent_page ) {
 ...
 */
function CG_Dev\\get_plugin_page_hookname( $plugin_page, $parent_page ) {
 ...
 */
function CG_Dev\\user_can_access_admin_page() {
 ...
 * @return array
 */
function CG_Dev\\option_update_filter( $options ) {
 ...
 * @return array
 */
function CG_Dev\\add_allowed_options( $new_options, $options = '' ) {
	if ( '' === $options ) {
 ...
 * @return array
 */
function CG_Dev\\remove_allowed_options( $del_options, $options = '' ) {
	if ( '' === $options ) {
		global $allowed_options;
	} else {
		$allowed_options = $options;
 ...
 */
function CG_Dev\\settings_fields( $option_group ) {
 ...
 */
function CG_Dev\\wp_clean_plugins_cache( $clear_update_cache = true ) {
 ...
 * @param string $plugin Path to the plugin file relative to the plugins directory.
 */
function CG_Dev\\plugin_sandbox_scrape( $plugin ) {
 ...
 */
function CG_Dev\\wp_add_privacy_policy_content( $plugin_name, $policy_text ) {
	if ( ! is_admin() ) {
		_doing_it_wrong(
			__FUNCTION__,
			sprintf(
 ...
 */
function CG_Dev\\is_plugin_paused( $plugin ) {
 ...
 */
function CG_Dev\\wp_get_plugin_error( $plugin ) {
	if ( ! isset( $GLOBALS['_paused_plugins'] ) ) {
		return false;
	}
 ...
 *                       `WP_Error` on failure.
 */
function CG_Dev\\resume_plugin( $plugin, $redirect = '' ) {
	/*
 ...
 * @global WP_Paused_Extensions_Storage $_paused_plugins
 */
function CG_Dev\\paused_plugins_notice() {
 ...
 */
function CG_Dev\\deactivated_plugins_notice() {
	if ( 'plugins.php' === $GLOBALS['pagenow'] ) {
		return;
	}
