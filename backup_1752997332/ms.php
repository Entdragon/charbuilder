 ...
 */
function CG_Dev\\check_upload_size( $file ) {
 ...
 */
function CG_Dev\\wpmu_delete_blog( $blog_id, $drop = false ) {
	$blog_id = (int) $blog_id;
 ...
 */
function CG_Dev\\wpmu_delete_user( $id ) {
	global $wpdb;
 ...
 */
function CG_Dev\\upload_is_user_over_quota( $display_message = true ) {
	if ( get_site_option( 'upload_space_check_disabled' ) ) {
		return false;
	}
 ...
 * @since MU (3.0.0)
 */
function CG_Dev\\display_space_usage() {
	$space_allowed = get_space_allowed();
	$space_used    = get_space_used();
 ...
 */
function CG_Dev\\fix_import_form_size( $size ) {
	if ( upload_is_user_over_quota( false ) ) {
		return 0;
	}
 ...
 */
function CG_Dev\\upload_space_setting( $id ) {
	switch_to_blog( $id );
 ...
 */
function CG_Dev\\refresh_user_details( $id ) {
	$id = (int) $id;
 ...
 */
function CG_Dev\\format_code_lang( $code = '' ) {
 ...
 * @access private
 */
function CG_Dev\\_access_denied_splash() {
 ...
 */
function CG_Dev\\check_import_new_users( $permission ) {
 ...
 */
function CG_Dev\\mu_dropdown_languages( $lang_files = array(), $current = '' ) {
	$flag   = false;
	$output = array();
 ...
 */
function CG_Dev\\site_admin_notice() {
 ...
 */
function CG_Dev\\avoid_blog_page_permalink_collision( $data, $postarr ) {
 ...
 * @since 3.0.0
 */
function CG_Dev\\choose_primary_blog() {
	?>
 ...
 */
function CG_Dev\\can_edit_network( $network_id ) {
 ...
 * @access private
 */
function CG_Dev\\_thickbox_path_admin_subfolder() {
	?>
 ...
 * @return bool
 */
function CG_Dev\\confirm_delete_users( $users ) {
 ...
 * }
 */
function CG_Dev\\network_edit_site_nav( $args = array() ) {
 ...
 */
function CG_Dev\\get_site_screen_help_tab_args() {
	return array(
		'id'      => 'overview',
		'title'   => __( 'Overview' ),
		'content' =>
 ...
 */
function CG_Dev\\get_site_screen_help_sidebar_content() {
 ...
 */
function CG_Dev\\wp_ensure_editable_role( $role ) {
