 ...
 */
function CG_Dev\\allow_subdomain_install() {
 ...
 */
function CG_Dev\\allow_subdirectory_install() {
	global $wpdb;
 ...
 */
function CG_Dev\\get_clean_basedomain() {
