 ...
 */
function CG_Dev\\_block_bindings_pattern_overrides_get_value( array $source_args, $block_instance, string $attribute_name ) {
 ...
 * @access private
 */
function CG_Dev\\_register_block_bindings_pattern_overrides_source() {
