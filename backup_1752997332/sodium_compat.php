...
if (!is_callable('\\Sodium\\crypto_aead_aes256gcm_decrypt')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\crypto_aead_aes256gcm_decrypt(
        $message,
        $assocData,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('\\Sodium\\crypto_aead_aes256gcm_encrypt')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_aead_aes256gcm_encrypt(
        #[\SensitiveParameter]
        $message,
        $assocData,
        $nonce,
...
if (!is_callable('\\Sodium\\crypto_aead_aes256gcm_is_available')) {
     ...
     * @return bool
     */
    function CG_Dev\\crypto_aead_aes256gcm_is_available()
    {
...
if (!is_callable('\\Sodium\\crypto_aead_chacha20poly1305_decrypt')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\crypto_aead_chacha20poly1305_decrypt(
        $message,
        $assocData,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('\\Sodium\\crypto_aead_chacha20poly1305_encrypt')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_aead_chacha20poly1305_encrypt(
        #[\SensitiveParameter]
        $message,
        $assocData,
        $nonce,
...
if (!is_callable('\\Sodium\\crypto_aead_chacha20poly1305_ietf_decrypt')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\crypto_aead_chacha20poly1305_ietf_decrypt(
        $message,
        $assocData,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('\\Sodium\\crypto_aead_chacha20poly1305_ietf_encrypt')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_aead_chacha20poly1305_ietf_encrypt(
        #[\SensitiveParameter]
        $message,
        $assocData,
        $nonce,
...
if (!is_callable('\\Sodium\\crypto_auth_verify')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_auth_verify(
        $mac,
        $message,
        #[\SensitiveParameter]
        $key
...
if (!is_callable('\\Sodium\\crypto_box_keypair')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_box_keypair()
    {
...
if (!is_callable('\\Sodium\\crypto_box_keypair_from_secretkey_and_publickey')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_box_keypair_from_secretkey_and_publickey(
        #[\SensitiveParameter]
        $sk,
        $pk
    ) {
...
if (!is_callable('\\Sodium\\crypto_box_open')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\crypto_box_open(
        #[\SensitiveParameter]
        $message,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('\\Sodium\\crypto_box_publickey')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_box_publickey(
        #[\SensitiveParameter]
        $keypair
    ) {
...
if (!is_callable('\\Sodium\\crypto_box_publickey_from_secretkey')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_box_publickey_from_secretkey(
        #[\SensitiveParameter]
        $sk
    ) {
...
if (!is_callable('\\Sodium\\crypto_box_seal')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_box_seal(
        #[\SensitiveParameter]
        $message,
        $publicKey
    ) {
...
if (!is_callable('\\Sodium\\crypto_box_seal_open')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\crypto_box_seal_open(
        $message,
        #[\SensitiveParameter]
        $kp
    ) {
...
if (!is_callable('\\Sodium\\crypto_box_secretkey')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_box_secretkey(
        #[\SensitiveParameter]
        $keypair
    ) {
...
if (!is_callable('\\Sodium\\crypto_generichash')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_generichash(
        $message,
        #[\SensitiveParameter]
        $key = null,
        $outLen = 32
...
if (!is_callable('\\Sodium\\crypto_generichash_final')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_generichash_final(
        #[\SensitiveParameter]
        &$ctx,
        $outputLength = 32
    ) {
...
if (!is_callable('\\Sodium\\crypto_generichash_init')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_generichash_init(
        #[\SensitiveParameter]
        $key = null,
        $outLen = 32
    ) {
...
if (!is_callable('\\Sodium\\crypto_generichash_update')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_generichash_update(
        #[\SensitiveParameter]
        &$ctx,
        $message = ''
    ) {
...
if (!is_callable('\\Sodium\\crypto_pwhash_str')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_pwhash_str(
        #[\SensitiveParameter]
        $passwd,
        $opslimit,
        $memlimit
...
if (!is_callable('\\Sodium\\crypto_pwhash_str_verify')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_pwhash_str_verify(
        #[\SensitiveParameter]
        $passwd,
        #[\SensitiveParameter]
        $hash
...
if (!is_callable('\\Sodium\\crypto_pwhash_scryptsalsa208sha256')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_pwhash_scryptsalsa208sha256(
        $outlen,
        #[\SensitiveParameter]
        $passwd,
        #[\SensitiveParameter]
...
if (!is_callable('\\Sodium\\crypto_pwhash_scryptsalsa208sha256_str')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_pwhash_scryptsalsa208sha256_str(
        #[\SensitiveParameter]
        $passwd,
        $opslimit,
        $memlimit
...
if (!is_callable('\\Sodium\\crypto_pwhash_scryptsalsa208sha256_str_verify')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_pwhash_scryptsalsa208sha256_str_verify(
        #[\SensitiveParameter]
        $passwd,
        #[\SensitiveParameter]
        $hash
...
if (!is_callable('\\Sodium\\crypto_scalarmult')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_scalarmult(
        #[\SensitiveParameter]
        $n,
        $p
    ) {
...
if (!is_callable('\\Sodium\\crypto_scalarmult_base')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_scalarmult_base(
        #[\SensitiveParameter]
        $n
    ) {
...
if (!is_callable('\\Sodium\\crypto_secretbox')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_secretbox(
        #[\SensitiveParameter]
        $message,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('\\Sodium\\crypto_secretbox_open')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\crypto_secretbox_open(
        $message,
        $nonce,
        #[\SensitiveParameter]
        $key
...
if (!is_callable('\\Sodium\\crypto_shorthash')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_shorthash(
        $message,
        #[\SensitiveParameter]
        $key = ''
    ) {
...
if (!is_callable('\\Sodium\\crypto_sign_detached')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_detached(
        $message,
        #[\SensitiveParameter]
        $sk
    ) {
...
if (!is_callable('\\Sodium\\crypto_sign_keypair')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_keypair()
    {
...
if (!is_callable('\\Sodium\\crypto_sign_open')) {
     ...
     * @return string|bool
     */
    function CG_Dev\\crypto_sign_open($signedMessage, $pk)
    {
        try {
...
if (!is_callable('\\Sodium\\crypto_sign_publickey')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_publickey(
        #[\SensitiveParameter]
        $keypair
    ) {
...
if (!is_callable('\\Sodium\\crypto_sign_publickey_from_secretkey')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_publickey_from_secretkey(
        #[\SensitiveParameter]
        $sk
    ) {
...
if (!is_callable('\\Sodium\\crypto_sign_secretkey')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_secretkey(
        #[\SensitiveParameter]
        $keypair
    ) {
...
if (!is_callable('\\Sodium\\crypto_sign_seed_keypair')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_seed_keypair(
        #[\SensitiveParameter]
        $seed
    ) {
...
if (!is_callable('\\Sodium\\crypto_sign_verify_detached')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_verify_detached($signature, $message, $pk)
    {
...
if (!is_callable('\\Sodium\\crypto_sign_ed25519_pk_to_curve25519')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_ed25519_pk_to_curve25519($pk)
    {
...
if (!is_callable('\\Sodium\\crypto_sign_ed25519_sk_to_curve25519')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_sign_ed25519_sk_to_curve25519(
        #[\SensitiveParameter]
        $sk
    ) {
...
if (!is_callable('\\Sodium\\crypto_stream_xor')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\crypto_stream_xor(
        #[\SensitiveParameter]
        $message,
        $nonce,
        #[\SensitiveParameter]
...
if (!is_callable('\\Sodium\\randombytes_buf')) {
     ...
     * @throws \TypeError
     */
    function CG_Dev\\randombytes_buf($amount)
    {
...
if (!is_callable('\\Sodium\\randombytes_uniform')) {
     ...
     * @throws \Error
     */
    function CG_Dev\\randombytes_uniform($upperLimit)
    {
...
if (!is_callable('\\Sodium\\randombytes_random16')) {
     ...
     * @return int
     */
    function CG_Dev\\randombytes_random16()
    {
