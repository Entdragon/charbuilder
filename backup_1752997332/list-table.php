 ...
 */
function CG_Dev\\_get_list_table( $class_name, $args = array() ) {
	$core_classes = array(
		// Site Admin.
 ...
 */
function CG_Dev\\register_column_headers( $screen, $columns ) {
 ...
 */
function CG_Dev\\print_column_headers( $screen, $with_id = true ) {
