 ...
 */
function CG_Dev\\_wp_admin_bar_init() {
	global $wp_admin_bar;
 ...
 * @global WP_Admin_Bar $wp_admin_bar
 */
function CG_Dev\\wp_admin_bar_render() {
	global $wp_admin_bar;
 ...
 */
function CG_Dev\\wp_admin_bar_wp_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_sidebar_toggle( $wp_admin_bar ) {
	if ( is_admin() ) {
		$wp_admin_bar->add_node(
			array(
				'id'    => 'menu-toggle',
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_my_account_item( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_my_account_menu( $wp_admin_bar ) {
	$user_id      = get_current_user_id();
	$current_user = wp_get_current_user();
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_site_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_edit_site_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_customize_menu( $wp_admin_bar ) {
	global $wp_customize;
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_my_sites_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_shortlink_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_edit_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_new_content_menu( $wp_admin_bar ) {
	$actions = array();
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_comments_menu( $wp_admin_bar ) {
	if ( ! current_user_can( 'edit_posts' ) ) {
		return;
	}
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_appearance_menu( $wp_admin_bar ) {
	$wp_admin_bar->add_group(
		array(
			'parent' => 'site-name',
			'id'     => 'appearance',
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_updates_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_search_menu( $wp_admin_bar ) {
	if ( is_admin() ) {
		return;
	}
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_recovery_mode_menu( $wp_admin_bar ) {
 ...
 * @param WP_Admin_Bar $wp_admin_bar The WP_Admin_Bar instance.
 */
function CG_Dev\\wp_admin_bar_add_secondary_groups( $wp_admin_bar ) {
	$wp_admin_bar->add_group(
		array(
			'id'   => 'top-secondary',
			'meta' => array(
 ...
 * @since 6.4.0
 */
function CG_Dev\\wp_enqueue_admin_bar_header_styles() {
 ...
 * @since 6.4.0
 */
function CG_Dev\\wp_enqueue_admin_bar_bump_styles() {
 ...
 */
function CG_Dev\\show_admin_bar( $show ) {
 ...
 */
function CG_Dev\\is_admin_bar_showing() {
 ...
 */
function CG_Dev\\_get_admin_bar_pref( $context = 'front', $user = 0 ) {
