 ...
 */
function CG_Dev\\get_option( $option, $default_value = false ) {
	global $wpdb;
 ...
 */
function CG_Dev\\wp_prime_option_caches( $options ) {
	global $wpdb;
 ...
 */
function CG_Dev\\wp_prime_option_caches_by_group( $option_group ) {
 ...
 */
function CG_Dev\\get_options( $options ) {
 ...
 *               was updated.
 */
function CG_Dev\\wp_set_option_autoload_values( array $options ) {
	global $wpdb;
 ...
 *               was updated.
 */
function CG_Dev\\wp_set_options_autoload( array $options, $autoload ) {
 ...
 */
function CG_Dev\\wp_set_option_autoload( $option, $autoload ) {
 ...
 * @param string $option Option name.
 */
function CG_Dev\\wp_protect_special_option( $option ) {
 ...
 * @param string $option Option name.
 */
function CG_Dev\\form_option( $option ) {
 ...
 */
function CG_Dev\\wp_load_alloptions( $force_cache = false ) {
	global $wpdb;
 ...
 * @param string[] $options An array of option names to be loaded.
 */
function CG_Dev\\wp_prime_site_option_caches( array $options ) {
 ...
 * @param string[] $options    An array of option names to be loaded.
 */
function CG_Dev\\wp_prime_network_option_caches( $network_id, array $options ) {
	global $wpdb;
 ...
 */
function CG_Dev\\wp_load_core_site_options( $network_id = null ) {
 ...
 */
function CG_Dev\\update_option( $option, $value, $autoload = null ) {
	global $wpdb;
 ...
 */
function CG_Dev\\add_option( $option, $value = '', $deprecated = '', $autoload = null ) {
	global $wpdb;
 ...
 */
function CG_Dev\\delete_option( $option ) {
	global $wpdb;
 ...
 */
function CG_Dev\\wp_determine_option_autoload_value( $option, $value, $serialized_value, $autoload ) {
 ...
 */
function CG_Dev\\wp_filter_default_autoload_value_via_option_size( $autoload, $option, $value, $serialized_value ) {
	/**
 ...
 */
function CG_Dev\\delete_transient( $transient ) {
 ...
 */
function CG_Dev\\get_transient( $transient ) {
 ...
 */
function CG_Dev\\set_transient( $transient, $value, $expiration = 0 ) {
 ...
 */
function CG_Dev\\delete_expired_transients( $force_db = false ) {
	global $wpdb;
 ...
 * @since 2.7.0
 */
function CG_Dev\\wp_user_settings() {
 ...
 */
function CG_Dev\\get_user_setting( $name, $default_value = false ) {
 ...
 */
function CG_Dev\\set_user_setting( $name, $value ) {
	if ( headers_sent() ) {
		return false;
	}
 ...
 *                   Null if the current user is not a member of the site.
 */
function CG_Dev\\delete_user_setting( $names ) {
	if ( headers_sent() ) {
		return false;
	}
 ...
 */
function CG_Dev\\get_all_user_settings() {
 ...
 *                   Null if the current user is not a member of the site.
 */
function CG_Dev\\wp_set_all_user_settings( $user_settings ) {
	global $_updated_user_settings;
 ...
 * @since 2.7.0
 */
function CG_Dev\\delete_all_user_settings() {
	$user_id = get_current_user_id();
	if ( ! $user_id ) {
		return;
	}
 ...
 */
function CG_Dev\\get_site_option( $option, $default_value = false, $deprecated = true ) {
 ...
 * @return bool True if the option was added, false otherwise.
 */
function CG_Dev\\add_site_option( $option, $value ) {
 ...
 * @return bool True if the option was deleted, false otherwise.
 */
function CG_Dev\\delete_site_option( $option ) {
 ...
 * @return bool True if the value was updated, false otherwise.
 */
function CG_Dev\\update_site_option( $option, $value ) {
 ...
 * @return mixed Value set for the option.
 */
function CG_Dev\\get_network_option( $network_id, $option, $default_value = false ) {
	global $wpdb;
 ...
 * @return bool True if the option was added, false otherwise.
 */
function CG_Dev\\add_network_option( $network_id, $option, $value ) {
	global $wpdb;
 ...
 * @return bool True if the option was deleted, false otherwise.
 */
function CG_Dev\\delete_network_option( $network_id, $option ) {
	global $wpdb;
 ...
 * @return bool True if the value was updated, false otherwise.
 */
function CG_Dev\\update_network_option( $network_id, $option, $value ) {
	global $wpdb;
 ...
 * @return bool True if the transient was deleted, false otherwise.
 */
function CG_Dev\\delete_site_transient( $transient ) {
 ...
 * @return mixed Value of transient.
 */
function CG_Dev\\get_site_transient( $transient ) {
 ...
 * @return bool True if the value was set, false otherwise.
 */
function CG_Dev\\set_site_transient( $transient, $value, $expiration = 0 ) {
 ...
 */
function CG_Dev\\register_initial_settings() {
	register_setting(
		'general',
		'blogname',
		array(
 ...
 * }
 */
function CG_Dev\\register_setting( $option_group, $option_name, $args = array() ) {
 ...
 */
function CG_Dev\\unregister_setting( $option_group, $option_name, $deprecated = '' ) {
	global $new_allowed_options, $wp_registered_settings;
 ...
 */
function CG_Dev\\get_registered_settings() {
 ...
 */
function CG_Dev\\filter_default_option( $default_value, $option, $passed_default ) {
	if ( $passed_default ) {
 ...
 */
function CG_Dev\\wp_autoload_values_to_autoload() {
