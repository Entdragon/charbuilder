...
final class UserFeedback_Admin_Notice {
	...
	public function __construct() {
		...
		// Populate $notices
		$this->notices = get_option( 'userfeedback_notices' );
	...
	public function dismiss( $notice ) {
		...
		update_option( 'userfeedback_notices', $this->notices );
	...
	/**
	 * Displays an inline notice with some UserFeedback styling.
	 *
	 * @access public
	 * @since 1.0.0
	 *
	 * @param string $name             Programmatic Notice Name
