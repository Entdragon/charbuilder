...
function uj_install_gifts(): int {
    ...
    $rows = [
        ...
        // ── Occult Horror — Supernatural Gifts (pp. 209-212) ──────────────────
        // Gifts of Supernatural Power (p. 209)
        ['Personal Power d6', 'personal-power',
         'Use supernatural powers',
         "You begin play with a Personal Power die of d6. This die is a dwindle die. Every time it is rolled, check to see if it rolls a 1. If it does, reduce its size by one. (So the first time it comes up one, it becomes a d4. The second time it comes up one, it dwindles to nothing.) You must roll a power die when casting supernatural effects. If you don't roll a power die, the supernatural effect fails to work. The rules for casting begin on page 188. You can cast Rituals. If you can find directions that you can read, and then get the materials that you need, you can use Rituals. You need at least one power die to cast for supernatural powers. You will need more gifts to unlock more powers. Characters cannot normally just buy Personal Power with experience points. They must have some sort of supernatural encounter, or they may have just begun the game with power as a mysterious chance of birth. The Host is discouraged from letting Player-Characters gain Personal Power without some compelling reason from the narrative. You can only buy this gift once. Personal power has limits. At the start of the next episode, your personal power die resets back to d6. (Whether it was gone, or a d4, or somehow it rose to a d8 or larger does not matter. When the next episode starts, it's back to a d6 in size.)",
         'basic', '', ''],
        ['Petitioned Power', 'petitioned-power',
         "Use supernatural's Opinion dice as power dice",
        ...
        ['Abjure Arcana 2d8', 'abjure-arcana',
         'bonus 2d8 when you declare an Abjure casting',
         "By focusing all your feeling, your anger, and all your sorrow, you can channel your PK energy into greater force. Before making a casting for Psychokinesis Magic, you may declare you will only be casting for effects with the \"Abjure\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Abjure\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', 'Requires: Psychokinesis'],
        ['Anodyne Arcana 2d8', 'anodyne-arcana',
         'bonus 2d8 when you declare an Anodyne casting',
         "You have mastered the discipline of perceiving the magnetic forces within others, to heal them with your psychic surgery. Before making a casting for Vitalism Magic, you may declare you will only be casting for effects with the \"Anodyne\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Anodyne\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', 'Requires: Vitalism'],
        ['Channeling Arcana 2d8', 'channeling-arcana',
         'bonus 2d8 when you declare a Channel casting',
         "Most fortune-tellers, mediums, spiritualists, and diviners master the art of channeling the spirits\u{2026} and then stop there. Before making a casting for Spiritual Magic, you may declare you will only be casting for effects with the \"Channel\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Channel\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', 'Requires: Spiritualism'],
        ['Coercive Arcana 2d8', 'coercive-arcana',
         'bonus 2d8 when you declare a Coercive casting',
         "You have concentrated your personal magnetism to overpower the consciousness of others. Before making a casting for Vitalism Magic, you may declare you will only be casting for effects with the \"Coercive\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Coercive\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', 'Requires: Vitalism'],
        ['Conniption Arcana 2d8', 'conniption-arcana',
         'bonus 2d8 when you declare a Conniption casting',
         "Your silent scream will be heard. Before making a casting for Telepathy Magic, you may declare you will only be casting for effects with the \"Conniption\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Conniption\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', 'Requires: Telepathy'],
        ['Dowsing Arcana 2d8', 'dowsing-arcana',
         'bonus 2d8 when you declare a Dowsing casting',
         "A folk wisdom passed down for generations, you have honed your power to find things that are lost. Before making a casting for ESP Magic, you may declare you will only be casting for effects with the \"Dowsing\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Dowsing\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', 'Requires: Extra-Sensory Perception'],
        ['Hasty Arcana 2d8', 'hasty-arcana',
         'bonus 2d8 when you declare a Hasty casting',
         "It's all well and good to talk about magic as some impractical exercise to impress rich people in the parlor. When you're in the field, you need to be quick with your wits. Before making a casting, you may declare you will only be casting for effects with the \"Hasty\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Hasty\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', ''],
        ['Mass Arcana 2d8', 'mass-arcana',
         'bonus 2d8 when you declare a Mass casting',
         "The most difficult magic is the kind that affects a crowd. Therefore, it's the kind of magic that you have taken great pains to learn. Before making a casting, you may declare you will only be casting for effects with the \"Mass\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Mass\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', ''],
        ['Meticulous Arcana 2d8', 'meticulous-arcana',
         'bonus 2d8 when you declare a Scene or Day casting',
         "Rituals cost a lot of money, have many procedures to follow, and can only be done at certain times. It's the poor practitioner that makes excuses for their own sloppiness. Before making a casting, you may declare you will only be casting for effects with the \"Scene\" descriptor or with the \"Day\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with either the \"Scene\" descriptor or the \"Day\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', ''],
        ['Oneiric Arcana 2d8', 'oneiric-arcana',
         'bonus 2d8 when you declare an Oneiric casting',
         "Telepathy is about making a connection with others on a spiritual level. To know others is to know yourself. Before making a casting for Telepathy Magic, you may declare you will only be casting for effects with the \"Oneiric\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Oneiric\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', 'Requires: Telepathy'],
        ['Protection Arcana 2d8', 'protection-arcana',
         'bonus 2d8 when you declare a Protect casting',
         "As you walk through the darkest valleys, you will fear no evil. The most practical magic is the kind that stops other practitioners from using their magic. Before making a casting, you may declare you will only be casting for effects with the \"Protect\" descriptor. You gain a 2d8 bonus to your casting roll, but you may only select effects with the \"Protect\" descriptor \u{2013} all other effects will fail.",
         'advanced', '', ''],
        ['Retro Arcana 2d8', 'retro-arcana',
