...
(function () {
  ...
  const SIMPLE_PANES = {
    ...
    'uj-gifts': {
      ...
      fields: [
        ...
        { col: 'requires_text', label: 'Requires', textarea: true },
        { col: 'page_number',   label: 'Page #' },
        { col: 'source_book',   label: 'Source Book' },
        { col: 'published',     label: 'Published', checkbox: true },
      ],
    },
    'uj-species': {
      ...
      fields: [
        ...
        { col: 'slug',        label: 'Slug' },
        { col: 'description', label: 'Description', textarea: true, tall: true },
        { col: 'skill_1',     label: 'Skill 1' },
        { col: 'skill_2',     label: 'Skill 2' },
        { col: 'skill_3',     label: 'Skill 3' },
        { col: 'gift_1',      label: 'Gift 1' },
        { col: 'gift_2',      label: 'Gift 2' },
        { col: 'page_number', label: 'Page #' },
        { col: 'source_book', label: 'Source Book' },
        { col: 'published',   label: 'Published', checkbox: true },
      ],
    ...
    'uj-types': {
      ...
      fields: [
        ...
        { col: 'skill_2',     label: 'Skill 2' },
        { col: 'skill_3',     label: 'Skill 3' },
        { col: 'gift_1',      label: 'Gift' },
        { col: 'soak_1',      label: 'Soak 1' },
        { col: 'soak_2',      label: 'Soak 2' },
        { col: 'gear',        label: 'Starting Gear', textarea: true },
        { col: 'page_number', label: 'Page #' },
        { col: 'source_book', label: 'Source Book' },
        { col: 'published',   label: 'Published', checkbox: true },
      ],
  ...
  document.getElementById('cga-save').addEventListener('click', async () => {
    ...
    try {
      ...
      } else if (isNew && pane === 'ic-gifts') {
        const res = await post('cg_admin_create_gift', params);
        if (res.success) {
          status('Created ✓', 'ok');
          isNew = false;
          curId = res.data.id;
      ...
      } else if (isNew && pane === 'ic-weapons') {
        const res = await post('cg_admin_create_weapon', params);
        if (res.success) {
          status('Created ✓', 'ok');
          isNew = false;
          curId = res.data.id;
